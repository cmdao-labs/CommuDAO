    ...
    return (
        <>
            <div style={{margin: "20px 0", width: "750px", maxWidth: "100%", display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "center"}}>
                <div style={{marginTop: "20px", padding: "20px 0", height: "450px", width: "350px"}} className="nftCard">
                    ...
                    {swapMode === 0 || swapMode === 1 ?
                        <div style={{letterSpacing: "1px", width: "250px", padding: "15px 30px", height: "fit-content", cursor: "pointer", borderRadius: "16px", backgroundColor: "rgb(97, 218, 251)", color: "#fff", fontSize: "18px"}} className="bold" onClick={swapTokenHandle}>Swap</div> :
                        <></>
                    }
                    {swapMode === 2 || swapMode === 3 ?
                        <div style={{letterSpacing: "1px", width: "250px", padding: "15px 30px", height: "fit-content", cursor: "pointer", borderRadius: "16px", backgroundColor: "rgb(97, 218, 251)", color: "#fff", fontSize: "18px"}} className="bold" onClick={swapTokenHandle2}>Swap</div> :
                        <></>
                    }
                </div>
            </div>
