                ...
                <div style={{textAlign: "left", height: "fit-content", width: "90%", display: "flex", flexDirection: "column", justifyContent: "flex-start"}} className="pixel">
                    ...
                    <div style={{width: "100%", display: "flex", flexDirection: "row", justifyContent: "flex-start", overflow: "scroll"}} className="noscroll">
                        <div style={{width: "200px", minWidth: "200px", height: "55px", margin: "20px 10px", fontSize: "15px", border: "1px solid #dddade", boxShadow: "3px 3px 0 #dddade"}} className="items">
                            <img
                                src={providerIPFS + "bafkreidfaoq6ewqfoipdm66wapq4kijjhxdueztpo6tvdhayprueihefrm"}
                                width="20"
                                alt="$BST"
                                    ...
                                    await ethereum.request({
                                        ...
                                        params: {
                                            ...
                                            options: {
                                                ...
                                                symbol: 'BST',
                                                decimals: 18,
                                                image: providerIPFS + 'bafkreidfaoq6ewqfoipdm66wapq4kijjhxdueztpo6tvdhayprueihefrm',
                                            },
                                        },
                                    })
                                }}
                        ...
                        <div style={{width: "200px", minWidth: "200px", height: "55px", margin: "20px 10px", fontSize: "15px", border: "1px solid #dddade", boxShadow: "3px 3px 0 #dddade"}} className="items">
                            <img
                                src={providerIPFS + "bafkreicj63qksujn46s6skyyvqeny2fmptp2eu5u6hcicawalqjhtopm34"}
                                width="20"
                                alt="$SALM"
                                style={{cursor: "crosshair"}}
                                onClick={async () => {
                                    await ethereum.request({
                                        ...
                                        params: {
                                            ...
                                            options: {
                                                ...
                                                symbol: 'SALM',
                                                decimals: 18,
                                                image: providerIPFS + 'bafkreicj63qksujn46s6skyyvqeny2fmptp2eu5u6hcicawalqjhtopm34',
                                            },
                                        },
                                    })
                                }}
                        ...
                        <div style={{width: "200px", minWidth: "200px", height: "55px", margin: "20px 10px", fontSize: "15px", border: "1px solid #dddade", boxShadow: "3px 3px 0 #dddade"}} className="items">
                            <img
                                src={providerIPFS + "bafkreih75ehweqjdk6u6xowwdxs5hmdohib7sen2vlnuekzttzo2jk64iy"}
                                width="20"
                                alt="$TIER"
                                style={{cursor: "crosshair"}}
                                onClick={async () => {
                                    await ethereum.request({
                                        ...
                                        params: {
                                            ...
                                            options: {
                                                ...
                                                symbol: 'TIER',
                                                decimals: 0,
                                                image: providerIPFS + 'bafkreih75ehweqjdk6u6xowwdxs5hmdohib7sen2vlnuekzttzo2jk64iy',
                                            },
                                        },
                                    })
                                }}
                        ...
                        <div style={{width: "200px", minWidth: "200px", height: "55px", margin: "20px 10px", fontSize: "15px", border: "1px solid #dddade", boxShadow: "3px 3px 0 #dddade"}} className="items">
                            <img
                                src={providerIPFS + "bafkreibueyqenddliwzqeoafwtlktmnm33xqhfkxknucigj7ovpr7y5qeq"}
                                width="20"
                                alt="$AGUA"
                                style={{cursor: "crosshair"}}
                                onClick={async () => {
                                    await ethereum.request({
                                        ...
                                        params: {
                                            ...
                                            options: {
                                                ...
                                                symbol: 'AGUA',
                                                decimals: 0,
                                                image: providerIPFS + 'bafkreibueyqenddliwzqeoafwtlktmnm33xqhfkxknucigj7ovpr7y5qeq',
                                            },
                                        },
                                    })
                                }}
                    ...
                    <div style={{width: "100%", margin: "10px 0 80px 0", display: "flex", flexDirection: "row", justifyContent: "flex-start", overflow: "scroll"}} className="noscroll">
                        <div className="nftCard" style={{position: "relative", justifyContent: "space-around", margin: "20px", paddingTop: "60px"}}>
                            ...
                            <div style={{marginTop: "5px", width: "320px", display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-between", borderBottom: "1px solid #d9d8df"}} className="pixel">
                                ...
                                <div style={{display: "flex", flexDirection: "row", fontSize: "15px"}}>
                                    <img src={providerIPFS + "bafkreidfaoq6ewqfoipdm66wapq4kijjhxdueztpo6tvdhayprueihefrm"} height="18" alt="$BST"/>
                                    <div style={{margin: "0 5px"}}>10</div>
                                    <i style={{fontSize: "16px", margin: "2.5px 10px 2.5px 5px"}} className="fa fa-caret-right"></i>
                                    <img src={providerIPFS + "bafkreih75ehweqjdk6u6xowwdxs5hmdohib7sen2vlnuekzttzo2jk64iy"} height="18" alt="$TIER"/>
                                ...
                                {Number(bstLabLog[1]) === 0 &&
                                    <>
                                        ...
                                        <div style={{display: "flex", flexDirection: "row"}}>
                                            <img src={providerIPFS + "bafkreig4iub6bvecuksnma4a2s6wz5se2p3agupaz46bi7oyyksaq3zx4a"} height="18" alt="$CMJ.b"/>
                        ...
                        <div className="nftCard" style={{position: "relative", justifyContent: "space-around", margin: "20px", paddingTop: "60px"}}>
                            ...
                            <div style={{marginTop: "5px", width: "320px", display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-between", borderBottom: "1px solid #d9d8df"}} className="pixel">
                                <div><i style={{fontSize: "18px", marginRight: "5px"}} className="fa fa-flask"></i></div>
                                <div style={{display: "flex", flexDirection: "row", fontSize: "15px"}}>
                                    <img src={providerIPFS + "bafkreicj63qksujn46s6skyyvqeny2fmptp2eu5u6hcicawalqjhtopm34"} height="18" alt="$SALM"/>
                                    <div style={{margin: "0 5px"}}>10</div>
                                    <i style={{fontSize: "16px", margin: "2.5px 10px 2.5px 5px"}} className="fa fa-caret-right"></i>
                                    <img src={providerIPFS + "bafkreibueyqenddliwzqeoafwtlktmnm33xqhfkxknucigj7ovpr7y5qeq"} height="18" alt="$AGUA"/>
