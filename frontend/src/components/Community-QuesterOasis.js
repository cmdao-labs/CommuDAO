...
const QuesterOasis = ({ setisLoading, txupdate, setTxupdate, erc20ABI, kycABI, quest01ABI, pvp01ABI, questBBQABI, questAmbassABI, bbqLab01ABI, enderPotteryABI, dunCopperABI, dunJasperABI, cmdaoNameABI }) => {
    ...
    React.useEffect(() => {      
        ...
        const thefetch = async () => {
            ...
            const spend1Event = await jusdtSC.queryFilter(spend1Filter, 3103639, 'latest')
            ...
            const spend2Event = await jusdtSC.queryFilter(spend2Filter, 3103639, 'latest')
            ...
            const spend3Event = await jusdtSC.queryFilter(spend3Filter, 3103639, 'latest')
            ...
            const spend4Event = await jusdtSC.queryFilter(spend4Filter, 3103639, 'latest')
            ...
            const spend5Event = await jusdtSC.queryFilter(spend5Filter, 3103639, 'latest')
            ...
            const spend6Event = await jusdtSC.queryFilter(spend6Filter, 3103639, 'latest')
            ...
            const spend7Event = await jusdtSC.queryFilter(spend7Filter, 3103639, 'latest')
            ...
            const jdaoFarmEvent = await jdaoSC.queryFilter(jdaoFarmFilter, 3103639, 'latest')
