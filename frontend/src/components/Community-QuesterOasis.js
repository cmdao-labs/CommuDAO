...
const QuesterOasis = ({ setisLoading, txupdate, setTxupdate, erc20ABI, kycABI, quest01ABI, pvp01ABI, questBBQABI, questAmbassABI, bbqLab01ABI, enderPotteryABI, dunCopperABI, dunJasperABI, cmdaoNameABI }) => {
    ...
    React.useEffect(() => {      
        ...
        const thefetch = async () => {
            ...
            const spend1Event = await jusdtSC.queryFilter(spend1Filter, 3004475, 'latest')
            ...
            const spend2Event = await jusdtSC.queryFilter(spend2Filter, 3004475, 'latest')
            ...
            const spend3Event = await jusdtSC.queryFilter(spend3Filter, 3004475, 'latest')
            ...
            const spend4Event = await jusdtSC.queryFilter(spend4Filter, 3004475, 'latest')
            ...
            const spend5Event = await jusdtSC.queryFilter(spend5Filter, 3004475, 'latest')
            ...
            const spend6Event = await jusdtSC.queryFilter(spend6Filter, 3004475, 'latest')
            ...
            const spend7Event = await jusdtSC.queryFilter(spend7Filter, 3004475, 'latest')
                            ...
                            <div style={{height: "240px", width: "400px", textAlign: "left", display: "flex", flexDirection: "column", justifyContent: "space-between", flexFlow: "column wrap", fontSize: "14px"}}>
                                <div>
                                    ...
                                    <div style={{marginTop: "10px", width: "fit-content", display: "flex", flexDirection: "row", fontSize: "28px"}} className="bold">
                                        ...
                                        <img src="https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafkreigld4xmmrmu763t2vsju3tqhcodgxxsrmgvrlfhdjktgujgcmpmde" height="30px" alt="$SIL"/>
                                    </div>
                                </div>
                                <div>
                                    <div className="bold">QUEST DETAIL</div>
                            ...
                            <div style={{height: "240px", width: "400px", textAlign: "left", display: "flex", flexDirection: "column", justifyContent: "space-between", flexFlow: "column wrap", fontSize: "14px"}}>
                                <div>
                                    ...
                                    <div style={{marginTop: "10px", width: "fit-content", display: "flex", flexDirection: "row", fontSize: "28px"}} className="bold">
                                        ...
                                        <img src="https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafkreibf7vowyqjrcaeyslflrxxchel3b4qdpwxcxb34js2otg35vjkcaa" height="30px" alt="$PLAT"/>
                                    </div>
                                </div>
                                <div>
                                    <div className="bold">QUEST DETAIL</div>
