...
const QuesterOasis = ({ setisLoading, txupdate, setTxupdate, erc20ABI, kycABI, quest01ABI, pvp01ABI, questBBQABI, questAmbassABI, bbqLab01ABI, dunCopperABI, dunJasperABI }) => {
    ...
    React.useEffect(() => {      
        ...
        const thefetch = async () => {
            ...
            const spend1Event = await jusdtSC.queryFilter(spend1Filter, 1817950, 'latest')
            ...
            const spend2Event = await jusdtSC.queryFilter(spend2Filter, 1817950, 'latest')
            ...
            const spend3Event = await jusdtSC.queryFilter(spend3Filter, 1817950, 'latest')
            ...
            const spend4Event = await jusdtSC.queryFilter(spend4Filter, 1817950, 'latest')
