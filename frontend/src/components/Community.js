            ...
            <div style={{padding: 0, margin: "0 20px", borderRadius: 0, border: "none", background: "transparent", boxShadow: "none", width: "1216px", height: "1216px", display: "flex", flexFlow: "column wrap", justifyContent: "flex-start", alignItems: "flex-start", flexWrap: "wrap", overflow: "scroll"}} className="nftCard noscroll">
                ...
                <div id="tile1" className='emp tile' style={{position: "relative", width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column",  justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "#fff"}} onClick={() => {callMode(45); navigate('/community/cm-city/a01');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}>
                        {(slot1Lv !== null && Number(slot1Lv[0]) === 0) && <img src="https://gateway.commudao.xyz/ipfs/bafybeibx4jdpjujrjqbax7megps3n2ynkh2sxcbpuiyvme4xlcmrs5nvnu?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[0]) >= 1 && Number(slot1Lv[0]) <= 5) && <img src="https://gateway.commudao.xyz/ipfs/bafybeig2mzbeg2kt3jzlqjwbhso42kok37nmckm67ndtexjjl5abatigye?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[0]) >= 6 && Number(slot1Lv[0]) <= 10) && <img src="https://gateway.commudao.xyz/ipfs/Qmf7bVQFwz8tQ1eVJBqcMkq3jY4BQvDfdnZgLBY26Fb5RX?img-width=400&img-height=400" width="120" alt="HOUSE.LV.6" />}
                    </div>
                ...
                <div id="tile9" className='emp tile' style={{position: "relative", width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column",  justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "#fff"}} onClick={() => {callMode(45); navigate('/community/cm-city/a05');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}>
                        {(slot1Lv !== null && Number(slot1Lv[4]) === 0) && <img src="https://gateway.commudao.xyz/ipfs/bafybeibx4jdpjujrjqbax7megps3n2ynkh2sxcbpuiyvme4xlcmrs5nvnu?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[4]) >= 1 && Number(slot1Lv[4]) <= 5) && <img src="https://gateway.commudao.xyz/ipfs/bafybeig2mzbeg2kt3jzlqjwbhso42kok37nmckm67ndtexjjl5abatigye?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[4]) >= 6 && Number(slot1Lv[4]) <= 10) && <img src="https://gateway.commudao.xyz/ipfs/Qmf7bVQFwz8tQ1eVJBqcMkq3jY4BQvDfdnZgLBY26Fb5RX?img-width=400&img-height=400" width="120" alt="HOUSE.LV.6" />}
                    </div>
                ...
                <div id="tile17" className='emp tile' style={{position: "relative", width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column",  justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "#fff"}} onClick={() => {callMode(45); navigate('/community/cm-city/b01');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}>
                        {(slot1Lv !== null && Number(slot1Lv[11]) === 0) && <img src="https://gateway.commudao.xyz/ipfs/bafybeibx4jdpjujrjqbax7megps3n2ynkh2sxcbpuiyvme4xlcmrs5nvnu?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[11]) >= 1 && Number(slot1Lv[11]) <= 5) && <img src="https://gateway.commudao.xyz/ipfs/bafybeig2mzbeg2kt3jzlqjwbhso42kok37nmckm67ndtexjjl5abatigye?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[11]) >= 6 && Number(slot1Lv[11]) <= 10) && <img src="https://gateway.commudao.xyz/ipfs/Qmf7bVQFwz8tQ1eVJBqcMkq3jY4BQvDfdnZgLBY26Fb5RX?img-width=400&img-height=400" width="120" alt="HOUSE.LV.6" />}
                    </div>
                ...
                <div id="tile25" className='emp tile' style={{position: "relative", width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column",  justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "#fff"}} onClick={() => {callMode(45); navigate('/community/cm-city/b08');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}>
                        {(slot1Lv !== null && Number(slot1Lv[18]) === 0) && <img src="https://gateway.commudao.xyz/ipfs/bafybeibx4jdpjujrjqbax7megps3n2ynkh2sxcbpuiyvme4xlcmrs5nvnu?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[18]) >= 1 && Number(slot1Lv[18]) <= 5) && <img src="https://gateway.commudao.xyz/ipfs/bafybeig2mzbeg2kt3jzlqjwbhso42kok37nmckm67ndtexjjl5abatigye?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[18]) >= 6 && Number(slot1Lv[18]) <= 10) && <img src="https://gateway.commudao.xyz/ipfs/Qmf7bVQFwz8tQ1eVJBqcMkq3jY4BQvDfdnZgLBY26Fb5RX?img-width=400&img-height=400" width="120" alt="HOUSE.LV.6" />}
                    </div>
                ...
                <div id="tile33" className='emp tile' style={{position: "relative", width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column",  justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "#fff"}} onClick={() => {callMode(45); navigate('/community/cm-city/c01');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}>
                        {(slot1Lv !== null && Number(slot1Lv[23]) === 0) && <img src="https://gateway.commudao.xyz/ipfs/bafybeibx4jdpjujrjqbax7megps3n2ynkh2sxcbpuiyvme4xlcmrs5nvnu?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[23]) >= 1 && Number(slot1Lv[23]) <= 5) && <img src="https://gateway.commudao.xyz/ipfs/bafybeig2mzbeg2kt3jzlqjwbhso42kok37nmckm67ndtexjjl5abatigye?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[23]) >= 6 && Number(slot1Lv[23]) <= 10) && <img src="https://gateway.commudao.xyz/ipfs/Qmf7bVQFwz8tQ1eVJBqcMkq3jY4BQvDfdnZgLBY26Fb5RX?img-width=400&img-height=400" width="120" alt="HOUSE.LV.6" />}
                    </div>
                ...
                <div id="tile41" className='emp tile' style={{position: "relative", width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column",  justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "#fff"}} onClick={() => {callMode(45); navigate('/community/cm-city/c09');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}>
                        {(slot1Lv !== null && Number(slot1Lv[31]) === 0) && <img src="https://gateway.commudao.xyz/ipfs/bafybeibx4jdpjujrjqbax7megps3n2ynkh2sxcbpuiyvme4xlcmrs5nvnu?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[31]) >= 1 && Number(slot1Lv[31]) <= 5) && <img src="https://gateway.commudao.xyz/ipfs/bafybeig2mzbeg2kt3jzlqjwbhso42kok37nmckm67ndtexjjl5abatigye?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[31]) >= 6 && Number(slot1Lv[31]) <= 10) && <img src="https://gateway.commudao.xyz/ipfs/Qmf7bVQFwz8tQ1eVJBqcMkq3jY4BQvDfdnZgLBY26Fb5RX?img-width=400&img-height=400" width="120" alt="HOUSE.LV.6" />}
                    </div>
                ...
                <div id="tile49" className='emp tile' style={{position: "relative", width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column",  justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "#fff"}} onClick={() => {callMode(45); navigate('/community/cm-city/c12');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}>
                        {(slot1Lv !== null && Number(slot1Lv[34]) === 0) && <img src="https://gateway.commudao.xyz/ipfs/bafybeibx4jdpjujrjqbax7megps3n2ynkh2sxcbpuiyvme4xlcmrs5nvnu?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[34]) >= 1 && Number(slot1Lv[34]) <= 5) && <img src="https://gateway.commudao.xyz/ipfs/bafybeig2mzbeg2kt3jzlqjwbhso42kok37nmckm67ndtexjjl5abatigye?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[34]) >= 6 && Number(slot1Lv[34]) <= 10) && <img src="https://gateway.commudao.xyz/ipfs/Qmf7bVQFwz8tQ1eVJBqcMkq3jY4BQvDfdnZgLBY26Fb5RX?img-width=400&img-height=400" width="120" alt="HOUSE.LV.6" />}
                    </div>
                ...
                <div id="tile57" className='emp tile' style={{position: "relative", width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column",  justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "#fff"}} onClick={() => {callMode(45); navigate('/community/cm-city/c17');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}>
                        {(slot1Lv !== null && Number(slot1Lv[39]) === 0) && <img src="https://gateway.commudao.xyz/ipfs/bafybeibx4jdpjujrjqbax7megps3n2ynkh2sxcbpuiyvme4xlcmrs5nvnu?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[39]) >= 1 && Number(slot1Lv[39]) <= 5) && <img src="https://gateway.commudao.xyz/ipfs/bafybeig2mzbeg2kt3jzlqjwbhso42kok37nmckm67ndtexjjl5abatigye?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[39]) >= 6 && Number(slot1Lv[39]) <= 10) && <img src="https://gateway.commudao.xyz/ipfs/Qmf7bVQFwz8tQ1eVJBqcMkq3jY4BQvDfdnZgLBY26Fb5RX?img-width=400&img-height=400" width="120" alt="HOUSE.LV.6" />}
                    </div>
                ...
                <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}>
                        {(slot1Lv !== null && Number(slot1Lv[1]) === 0) && <img src="https://gateway.commudao.xyz/ipfs/bafybeibx4jdpjujrjqbax7megps3n2ynkh2sxcbpuiyvme4xlcmrs5nvnu?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[1]) >= 1 && Number(slot1Lv[1]) <= 5) && <img src="https://gateway.commudao.xyz/ipfs/bafybeig2mzbeg2kt3jzlqjwbhso42kok37nmckm67ndtexjjl5abatigye?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[1]) >= 6 && Number(slot1Lv[1]) <= 10) && <img src="https://gateway.commudao.xyz/ipfs/Qmf7bVQFwz8tQ1eVJBqcMkq3jY4BQvDfdnZgLBY26Fb5RX?img-width=400&img-height=400" width="120" alt="HOUSE.LV.6" />}
                    </div>
                ...
                <div id="tile10" className='emp tile' style={{position: "relative", width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column",  justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "#fff"}} onClick={() => {callMode(45); navigate('/community/cm-city/a06');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}>
                        {(slot1Lv !== null && Number(slot1Lv[5]) === 0) && <img src="https://gateway.commudao.xyz/ipfs/bafybeibx4jdpjujrjqbax7megps3n2ynkh2sxcbpuiyvme4xlcmrs5nvnu?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[5]) >= 1 && Number(slot1Lv[5]) <= 5) && <img src="https://gateway.commudao.xyz/ipfs/bafybeig2mzbeg2kt3jzlqjwbhso42kok37nmckm67ndtexjjl5abatigye?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[5]) >= 6 && Number(slot1Lv[5]) <= 10) && <img src="https://gateway.commudao.xyz/ipfs/Qmf7bVQFwz8tQ1eVJBqcMkq3jY4BQvDfdnZgLBY26Fb5RX?img-width=400&img-height=400" width="120" alt="HOUSE.LV.6" />}
                    </div>
                ...
                <div id="tile18" className='emp tile' style={{position: "relative", width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column",  justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "#fff"}} onClick={() => {callMode(45); navigate('/community/cm-city/b02');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}>
                        {(slot1Lv !== null && Number(slot1Lv[12]) === 0) && <img src="https://gateway.commudao.xyz/ipfs/bafybeibx4jdpjujrjqbax7megps3n2ynkh2sxcbpuiyvme4xlcmrs5nvnu?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[12]) >= 1 && Number(slot1Lv[12]) <= 5) && <img src="https://gateway.commudao.xyz/ipfs/bafybeig2mzbeg2kt3jzlqjwbhso42kok37nmckm67ndtexjjl5abatigye?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[12]) >= 6 && Number(slot1Lv[12]) <= 10) && <img src="https://gateway.commudao.xyz/ipfs/Qmf7bVQFwz8tQ1eVJBqcMkq3jY4BQvDfdnZgLBY26Fb5RX?img-width=400&img-height=400" width="120" alt="HOUSE.LV.6" />}
                    </div>
                ...
                <div id="tile26" className='emp tile' style={{position: "relative", width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column",  justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "#fff"}} onClick={() => {callMode(45); navigate('/community/cm-city/b09');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}>
                        {(slot1Lv !== null && Number(slot1Lv[19]) === 0) && <img src="https://gateway.commudao.xyz/ipfs/bafybeibx4jdpjujrjqbax7megps3n2ynkh2sxcbpuiyvme4xlcmrs5nvnu?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[19]) >= 1 && Number(slot1Lv[19]) <= 5) && <img src="https://gateway.commudao.xyz/ipfs/bafybeig2mzbeg2kt3jzlqjwbhso42kok37nmckm67ndtexjjl5abatigye?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[19]) >= 6 && Number(slot1Lv[19]) <= 10) && <img src="https://gateway.commudao.xyz/ipfs/Qmf7bVQFwz8tQ1eVJBqcMkq3jY4BQvDfdnZgLBY26Fb5RX?img-width=400&img-height=400" width="120" alt="HOUSE.LV.6" />}
                    </div>
                ...
                <div id="tile34" className='emp tile' style={{position: "relative", width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column",  justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "#fff"}} onClick={() => {callMode(45); navigate('/community/cm-city/c02');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}>
                        {(slot1Lv !== null && Number(slot1Lv[24]) === 0) && <img src="https://gateway.commudao.xyz/ipfs/bafybeibx4jdpjujrjqbax7megps3n2ynkh2sxcbpuiyvme4xlcmrs5nvnu?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[24]) >= 1 && Number(slot1Lv[24]) <= 5) && <img src="https://gateway.commudao.xyz/ipfs/bafybeig2mzbeg2kt3jzlqjwbhso42kok37nmckm67ndtexjjl5abatigye?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[24]) >= 6 && Number(slot1Lv[24]) <= 10) && <img src="https://gateway.commudao.xyz/ipfs/Qmf7bVQFwz8tQ1eVJBqcMkq3jY4BQvDfdnZgLBY26Fb5RX?img-width=400&img-height=400" width="120" alt="HOUSE.LV.6" />}
                    </div>
                ...
                <div id="tile42" className='emp tile' style={{position: "relative", width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column",  justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "#fff"}} onClick={() => {callMode(45); navigate('/community/cm-city/c10');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}>
                        {(slot1Lv !== null && Number(slot1Lv[32]) === 0) && <img src="https://gateway.commudao.xyz/ipfs/bafybeibx4jdpjujrjqbax7megps3n2ynkh2sxcbpuiyvme4xlcmrs5nvnu?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[32]) >= 1 && Number(slot1Lv[32]) <= 5) && <img src="https://gateway.commudao.xyz/ipfs/bafybeig2mzbeg2kt3jzlqjwbhso42kok37nmckm67ndtexjjl5abatigye?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[32]) >= 6 && Number(slot1Lv[32]) <= 10) && <img src="https://gateway.commudao.xyz/ipfs/Qmf7bVQFwz8tQ1eVJBqcMkq3jY4BQvDfdnZgLBY26Fb5RX?img-width=400&img-height=400" width="120" alt="HOUSE.LV.6" />}
                    </div>
                ...
                <div id="tile50" className='emp tile' style={{position: "relative", width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column",  justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "#fff"}} onClick={() => {callMode(45); navigate('/community/cm-city/c13');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}>
                        {(slot1Lv !== null && Number(slot1Lv[35]) === 0) && <img src="https://gateway.commudao.xyz/ipfs/bafybeibx4jdpjujrjqbax7megps3n2ynkh2sxcbpuiyvme4xlcmrs5nvnu?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[35]) >= 1 && Number(slot1Lv[35]) <= 5) && <img src="https://gateway.commudao.xyz/ipfs/bafybeig2mzbeg2kt3jzlqjwbhso42kok37nmckm67ndtexjjl5abatigye?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[35]) >= 6 && Number(slot1Lv[35]) <= 10) && <img src="https://gateway.commudao.xyz/ipfs/Qmf7bVQFwz8tQ1eVJBqcMkq3jY4BQvDfdnZgLBY26Fb5RX?img-width=400&img-height=400" width="120" alt="HOUSE.LV.6" />}
                    </div>
                ...
                <div id="tile58" className='emp tile' style={{position: "relative", width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column",  justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "#fff"}} onClick={() => {callMode(45); navigate('/community/cm-city/c18');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}>
                        {(slot1Lv !== null && Number(slot1Lv[40]) === 0) && <img src="https://gateway.commudao.xyz/ipfs/bafybeibx4jdpjujrjqbax7megps3n2ynkh2sxcbpuiyvme4xlcmrs5nvnu?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[40]) >= 1 && Number(slot1Lv[40]) <= 5) && <img src="https://gateway.commudao.xyz/ipfs/bafybeig2mzbeg2kt3jzlqjwbhso42kok37nmckm67ndtexjjl5abatigye?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[40]) >= 6 && Number(slot1Lv[40]) <= 10) && <img src="https://gateway.commudao.xyz/ipfs/Qmf7bVQFwz8tQ1eVJBqcMkq3jY4BQvDfdnZgLBY26Fb5RX?img-width=400&img-height=400" width="120" alt="HOUSE.LV.6" />}
                    </div>
                ...
                <div id="tile3" className="emp tile" style={{position: "relative", width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column", justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "rgb(0, 227, 180)"}} onClick={() => {callMode(41); navigate('/community/cmcity-citycenter');}}>
                    <div style={{height: "100px", display: "flex", alignItems: "flex-end", overflow: "visible"}}>
                        {/*<img src="https://gateway.commudao.xyz/ipfs/bafybeidtpeph5ix5phlf2et2i665lesc76pidjxiazlamumn6ncidpumle?img-width=400&img-height=400" width="120" alt="Can't load metadata" />*/}
                        {/*<img src="https://gateway.commudao.xyz/ipfs/bafybeiddh23ppumqcikjfskf7egy4ffbqbfpyi2wz3lglu47box35rfalm?img-width=400&img-height=400" width="120" alt="Can't load metadata" />*/}
                        <img src="https://gateway.commudao.xyz/ipfs/QmURSfHpQCMYbBBHGbzqkjGh8edPa7z2rVQhNVZHecXxfX?img-width=400&img-height=400" width="120" alt="Can't load metadata" />
                    </div>
                ...
                <div id="tile11" style={{width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column",  justifyContent: "flex-end", alignItems: "center", cursor: "not-allowed"}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}><img src="https://gateway.commudao.xyz/ipfs/bafybeiecefc3xbwj7mjd5pkpf7vb3mzu2xmce5t2h7ch4fq3xnz6gojclu" style={{filter: "grayscale(1)"}} width="120" alt="Can't load metadata" /></div>
                ...
                <div id="tile19" className='emp tile' style={{position: "relative", width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column",  justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "rgb(0, 227, 180)"}} onClick={() => {callMode(45); navigate('/community/cm-city/z06');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}>
                        {(slot1Lv !== null && Number(slot1Lv[46]) === 0) && <img src="https://gateway.commudao.xyz/ipfs/bafybeibx4jdpjujrjqbax7megps3n2ynkh2sxcbpuiyvme4xlcmrs5nvnu?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[46]) >= 1 && Number(slot1Lv[46]) <= 5) && <img src="https://gateway.commudao.xyz/ipfs/bafybeig2mzbeg2kt3jzlqjwbhso42kok37nmckm67ndtexjjl5abatigye?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[46]) >= 6 && Number(slot1Lv[46]) <= 10) && <img src="https://gateway.commudao.xyz/ipfs/Qmf7bVQFwz8tQ1eVJBqcMkq3jY4BQvDfdnZgLBY26Fb5RX?img-width=400&img-height=400" width="120" alt="HOUSE.LV.6" />}
                    </div>
                ...
                <div id="tile35" className='emp tile' style={{position: "relative", width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column",  justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "#fff"}} onClick={() => {callMode(45); navigate('/community/cm-city/c03');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}>
                        {(slot1Lv !== null && Number(slot1Lv[25]) === 0) && <img src="https://gateway.commudao.xyz/ipfs/bafybeibx4jdpjujrjqbax7megps3n2ynkh2sxcbpuiyvme4xlcmrs5nvnu?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[25]) >= 1 && Number(slot1Lv[25]) <= 5) && <img src="https://gateway.commudao.xyz/ipfs/bafybeig2mzbeg2kt3jzlqjwbhso42kok37nmckm67ndtexjjl5abatigye?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[25]) >= 6 && Number(slot1Lv[25]) <= 10) && <img src="https://gateway.commudao.xyz/ipfs/Qmf7bVQFwz8tQ1eVJBqcMkq3jY4BQvDfdnZgLBY26Fb5RX?img-width=400&img-height=400" width="120" alt="HOUSE.LV.6" />}
                    </div>
                ...
                <div id="tile43" className='emp tile' style={{position: "relative", width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column",  justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "rgb(0, 227, 180)"}} onClick={() => {callMode(45); navigate('/community/cm-city/z11');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}>
                        {(slot1Lv !== null && Number(slot1Lv[47]) === 0) && <img src="https://gateway.commudao.xyz/ipfs/bafybeibx4jdpjujrjqbax7megps3n2ynkh2sxcbpuiyvme4xlcmrs5nvnu?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[47]) >= 1 && Number(slot1Lv[47]) <= 5) && <img src="https://gateway.commudao.xyz/ipfs/bafybeig2mzbeg2kt3jzlqjwbhso42kok37nmckm67ndtexjjl5abatigye?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[47]) >= 6 && Number(slot1Lv[47]) <= 10) && <img src="https://gateway.commudao.xyz/ipfs/Qmf7bVQFwz8tQ1eVJBqcMkq3jY4BQvDfdnZgLBY26Fb5RX?img-width=400&img-height=400" width="120" alt="HOUSE.LV.6" />}
                    </div>
                ...
                <div id="tile4" className='emp tile' style={{position: "relative", width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column",  justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "rgb(0, 227, 180)"}} onClick={() => {callMode(45); navigate('/community/cm-city/z02');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}>
                        {(slot1Lv !== null && Number(slot1Lv[45]) === 0) && <img src="https://gateway.commudao.xyz/ipfs/bafybeibx4jdpjujrjqbax7megps3n2ynkh2sxcbpuiyvme4xlcmrs5nvnu?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[45]) >= 1 && Number(slot1Lv[45]) <= 5) && <img src="https://gateway.commudao.xyz/ipfs/bafybeig2mzbeg2kt3jzlqjwbhso42kok37nmckm67ndtexjjl5abatigye?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[45]) >= 6 && Number(slot1Lv[45]) <= 10) && <img src="https://gateway.commudao.xyz/ipfs/Qmf7bVQFwz8tQ1eVJBqcMkq3jY4BQvDfdnZgLBY26Fb5RX?img-width=400&img-height=400" width="120" alt="HOUSE.LV.6" />}
                    </div>
                ...
                <div id="tile12" className='emp tile' style={{position: "relative", width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column",  justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "#fff"}} onClick={() => {callMode(45); navigate('/community/cm-city/a07');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}>
                        {(slot1Lv !== null && Number(slot1Lv[6]) === 0) && <img src="https://gateway.commudao.xyz/ipfs/bafybeibx4jdpjujrjqbax7megps3n2ynkh2sxcbpuiyvme4xlcmrs5nvnu?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[6]) >= 1 && Number(slot1Lv[6]) <= 5) && <img src="https://gateway.commudao.xyz/ipfs/bafybeig2mzbeg2kt3jzlqjwbhso42kok37nmckm67ndtexjjl5abatigye?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[6]) >= 6 && Number(slot1Lv[6]) <= 10) && <img src="https://gateway.commudao.xyz/ipfs/Qmf7bVQFwz8tQ1eVJBqcMkq3jY4BQvDfdnZgLBY26Fb5RX?img-width=400&img-height=400" width="120" alt="HOUSE.LV.6" />}
                    </div>
                ...
                <div id="tile20" className='emp tile' style={{position: "relative", width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column",  justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "#fff"}} onClick={() => {callMode(45); navigate('/community/cm-city/b03');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}>
                        {(slot1Lv !== null && Number(slot1Lv[13]) === 0) && <img src="https://gateway.commudao.xyz/ipfs/bafybeibx4jdpjujrjqbax7megps3n2ynkh2sxcbpuiyvme4xlcmrs5nvnu?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[13]) >= 1 && Number(slot1Lv[13]) <= 5) && <img src="https://gateway.commudao.xyz/ipfs/bafybeig2mzbeg2kt3jzlqjwbhso42kok37nmckm67ndtexjjl5abatigye?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[13]) >= 6 && Number(slot1Lv[13]) <= 10) && <img src="https://gateway.commudao.xyz/ipfs/Qmf7bVQFwz8tQ1eVJBqcMkq3jY4BQvDfdnZgLBY26Fb5RX?img-width=400&img-height=400" width="120" alt="HOUSE.LV.6" />}
                    </div>
                ...
                <div id="tile36" className='emp tile' style={{position: "relative", width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column",  justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "#fff"}} onClick={() => {callMode(45); navigate('/community/cm-city/c04');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}>
                        {(slot1Lv !== null && Number(slot1Lv[26]) === 0) && <img src="https://gateway.commudao.xyz/ipfs/bafybeibx4jdpjujrjqbax7megps3n2ynkh2sxcbpuiyvme4xlcmrs5nvnu?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[26]) >= 1 && Number(slot1Lv[26]) <= 5) && <img src="https://gateway.commudao.xyz/ipfs/bafybeig2mzbeg2kt3jzlqjwbhso42kok37nmckm67ndtexjjl5abatigye?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[26]) >= 6 && Number(slot1Lv[26]) <= 10) && <img src="https://gateway.commudao.xyz/ipfs/Qmf7bVQFwz8tQ1eVJBqcMkq3jY4BQvDfdnZgLBY26Fb5RX?img-width=400&img-height=400" width="120" alt="HOUSE.LV.6" />}
                    </div>
                ...
                <div id="tile44" className="emp tile" style={{width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column", justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "rgb(0, 227, 180)"}} onClick={() => {callMode(44); navigate('/community/quester-oasis');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}><img src="https://gateway.commudao.xyz/ipfs/bafybeib2y7ckngdnsilvvgdix65v3l3bfejwc7zf4g5l46rsr7cgpalghy?img-width=400&img-height=400" width="120" alt="Can't load metadata" /></div>
                ...
                <div id="tile52" className='emp tile' style={{position: "relative", width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column",  justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "#fff"}} onClick={() => {callMode(45); navigate('/community/cm-city/c14');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}>
                        {(slot1Lv !== null && Number(slot1Lv[36]) === 0) && <img src="https://gateway.commudao.xyz/ipfs/bafybeibx4jdpjujrjqbax7megps3n2ynkh2sxcbpuiyvme4xlcmrs5nvnu?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[36]) >= 1 && Number(slot1Lv[36]) <= 5) && <img src="https://gateway.commudao.xyz/ipfs/bafybeig2mzbeg2kt3jzlqjwbhso42kok37nmckm67ndtexjjl5abatigye?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[36]) >= 6 && Number(slot1Lv[36]) <= 10) && <img src="https://gateway.commudao.xyz/ipfs/Qmf7bVQFwz8tQ1eVJBqcMkq3jY4BQvDfdnZgLBY26Fb5RX?img-width=400&img-height=400" width="120" alt="HOUSE.LV.6" />}
                    </div>
                ...
                <div id="tile60" className='emp tile' style={{position: "relative", width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column",  justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "#fff"}} onClick={() => {callMode(45); navigate('/community/cm-city/c19');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}>
                        {(slot1Lv !== null && Number(slot1Lv[41]) === 0) && <img src="https://gateway.commudao.xyz/ipfs/bafybeibx4jdpjujrjqbax7megps3n2ynkh2sxcbpuiyvme4xlcmrs5nvnu?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[41]) >= 1 && Number(slot1Lv[41]) <= 5) && <img src="https://gateway.commudao.xyz/ipfs/bafybeig2mzbeg2kt3jzlqjwbhso42kok37nmckm67ndtexjjl5abatigye?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[41]) >= 6 && Number(slot1Lv[41]) <= 10) && <img src="https://gateway.commudao.xyz/ipfs/Qmf7bVQFwz8tQ1eVJBqcMkq3jY4BQvDfdnZgLBY26Fb5RX?img-width=400&img-height=400" width="120" alt="HOUSE.LV.6" />}
                    </div>
                ...
                <div id="tile5" className="emp tile" style={{width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column", justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "rgb(0, 227, 180)"}} onClick={() => {callMode(46); navigate('/community/bigbro-analytica');}}>
                    <div style={{height: "100px", display: "flex", alignItems: "flex-end"}}><img src="https://gateway.commudao.xyz/ipfs/bafybeigbpmyjxigrzff356fq7pxv2755772trrky3tnxzh7zqyjiiv4qvi?img-width=400&img-height=400" width="120" alt="Can't load metadata" /></div>
                ...
                <div id="tile13" className='emp tile' style={{position: "relative", width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column",  justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "#fff"}} onClick={() => {callMode(45); navigate('/community/cm-city/a08');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}>
                        {(slot1Lv !== null && Number(slot1Lv[7]) === 0) && <img src="https://gateway.commudao.xyz/ipfs/bafybeibx4jdpjujrjqbax7megps3n2ynkh2sxcbpuiyvme4xlcmrs5nvnu?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[7]) >= 1 && Number(slot1Lv[7]) <= 5) && <img src="https://gateway.commudao.xyz/ipfs/bafybeig2mzbeg2kt3jzlqjwbhso42kok37nmckm67ndtexjjl5abatigye?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[7]) >= 6 && Number(slot1Lv[7]) <= 10) && <img src="https://gateway.commudao.xyz/ipfs/Qmf7bVQFwz8tQ1eVJBqcMkq3jY4BQvDfdnZgLBY26Fb5RX?img-width=400&img-height=400" width="120" alt="HOUSE.LV.6" />}
                    </div>
                ...
                <div id="tile21" className='emp tile' style={{position: "relative", width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column",  justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "#fff"}} onClick={() => {callMode(45); navigate('/community/cm-city/b04');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}>
                        {(slot1Lv !== null && Number(slot1Lv[14]) === 0) && <img src="https://gateway.commudao.xyz/ipfs/bafybeibx4jdpjujrjqbax7megps3n2ynkh2sxcbpuiyvme4xlcmrs5nvnu?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[14]) >= 1 && Number(slot1Lv[14]) <= 5) && <img src="https://gateway.commudao.xyz/ipfs/bafybeig2mzbeg2kt3jzlqjwbhso42kok37nmckm67ndtexjjl5abatigye?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[14]) >= 6 && Number(slot1Lv[14]) <= 10) && <img src="https://gateway.commudao.xyz/ipfs/Qmf7bVQFwz8tQ1eVJBqcMkq3jY4BQvDfdnZgLBY26Fb5RX?img-width=400&img-height=400" width="120" alt="HOUSE.LV.6" />}
                    </div>
                ...
                <div id="tile37" className='emp tile' style={{position: "relative", width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column",  justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "#fff"}} onClick={() => {callMode(45); navigate('/community/cm-city/c05');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}>
                        {(slot1Lv !== null && Number(slot1Lv[27]) === 0) && <img src="https://gateway.commudao.xyz/ipfs/bafybeibx4jdpjujrjqbax7megps3n2ynkh2sxcbpuiyvme4xlcmrs5nvnu?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[27]) >= 1 && Number(slot1Lv[27]) <= 5) && <img src="https://gateway.commudao.xyz/ipfs/bafybeig2mzbeg2kt3jzlqjwbhso42kok37nmckm67ndtexjjl5abatigye?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[27]) >= 6 && Number(slot1Lv[27]) <= 10) && <img src="https://gateway.commudao.xyz/ipfs/Qmf7bVQFwz8tQ1eVJBqcMkq3jY4BQvDfdnZgLBY26Fb5RX?img-width=400&img-height=400" width="120" alt="HOUSE.LV.6" />}
                    </div>
                ...
                <div id="tile53" className="emp tile" style={{width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column", justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "rgb(0, 227, 180)"}} onClick={() => {callMode(42); navigate('/community/dungeon-arena');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}><img src="https://gateway.commudao.xyz/ipfs/bafybeibbhvrdk32e6locxnyi2twe7wmryouulbl6ehvprtzqtum24kxvae?img-width=400&img-height=400" width="120" alt="Can't load metadata" /></div>
                ...
                <div id="tile61" className='emp tile' style={{position: "relative", width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column",  justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "#fff"}} onClick={() => {callMode(45); navigate('/community/cm-city/c20');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}>
                        {(slot1Lv !== null && Number(slot1Lv[42]) === 0) && <img src="https://gateway.commudao.xyz/ipfs/bafybeibx4jdpjujrjqbax7megps3n2ynkh2sxcbpuiyvme4xlcmrs5nvnu?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[42]) >= 1 && Number(slot1Lv[42]) <= 5) && <img src="https://gateway.commudao.xyz/ipfs/bafybeig2mzbeg2kt3jzlqjwbhso42kok37nmckm67ndtexjjl5abatigye?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[42]) >= 6 && Number(slot1Lv[42]) <= 10) && <img src="https://gateway.commudao.xyz/ipfs/Qmf7bVQFwz8tQ1eVJBqcMkq3jY4BQvDfdnZgLBY26Fb5RX?img-width=400&img-height=400" width="120" alt="HOUSE.LV.6" />}
                    </div>
                ...
                <div id="tile14" className='emp tile' style={{position: "relative", width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column",  justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "#fff"}} onClick={() => {callMode(45); navigate('/community/cm-city/a09');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}>
                        {(slot1Lv !== null && Number(slot1Lv[8]) === 0) && <img src="https://gateway.commudao.xyz/ipfs/bafybeibx4jdpjujrjqbax7megps3n2ynkh2sxcbpuiyvme4xlcmrs5nvnu?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[8]) >= 1 && Number(slot1Lv[8]) <= 5) && <img src="https://gateway.commudao.xyz/ipfs/bafybeig2mzbeg2kt3jzlqjwbhso42kok37nmckm67ndtexjjl5abatigye?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[8]) >= 6 && Number(slot1Lv[8]) <= 10) && <img src="https://gateway.commudao.xyz/ipfs/Qmf7bVQFwz8tQ1eVJBqcMkq3jY4BQvDfdnZgLBY26Fb5RX?img-width=400&img-height=400" width="120" alt="HOUSE.LV.6" />}
                    </div>
                ...
                <div id="tile22" className='emp tile' style={{position: "relative", width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column",  justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "#fff"}} onClick={() => {callMode(45); navigate('/community/cm-city/b05');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}>
                        {(slot1Lv !== null && Number(slot1Lv[15]) === 0) && <img src="https://gateway.commudao.xyz/ipfs/bafybeibx4jdpjujrjqbax7megps3n2ynkh2sxcbpuiyvme4xlcmrs5nvnu?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[15]) >= 1 && Number(slot1Lv[15]) <= 5) && <img src="https://gateway.commudao.xyz/ipfs/bafybeig2mzbeg2kt3jzlqjwbhso42kok37nmckm67ndtexjjl5abatigye?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[15]) >= 6 && Number(slot1Lv[15]) <= 10) && <img src="https://gateway.commudao.xyz/ipfs/Qmf7bVQFwz8tQ1eVJBqcMkq3jY4BQvDfdnZgLBY26Fb5RX?img-width=400&img-height=400" width="120" alt="HOUSE.LV.6" />}
                    </div>
                ...
                <div id="tile30" className='emp tile' style={{position: "relative", width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column",  justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "rgb(0, 227, 180)"}} onClick={() => {callMode(45); navigate('/community/cm-city/z10');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}>
                        {(slot1Lv !== null && Number(slot1Lv[20]) === 0) && <img src="https://gateway.commudao.xyz/ipfs/bafybeibx4jdpjujrjqbax7megps3n2ynkh2sxcbpuiyvme4xlcmrs5nvnu?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[20]) >= 1 && Number(slot1Lv[20]) <= 5) && <img src="https://gateway.commudao.xyz/ipfs/bafybeig2mzbeg2kt3jzlqjwbhso42kok37nmckm67ndtexjjl5abatigye?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[20]) >= 6 && Number(slot1Lv[20]) <= 10) && <img src="https://gateway.commudao.xyz/ipfs/Qmf7bVQFwz8tQ1eVJBqcMkq3jY4BQvDfdnZgLBY26Fb5RX?img-width=400&img-height=400" width="120" alt="HOUSE.LV.6" />}
                    </div>
                ...
                <div id="tile38" className='emp tile' style={{position: "relative", width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column",  justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "#fff"}} onClick={() => {callMode(45); navigate('/community/cm-city/c06');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}>
                        {(slot1Lv !== null && Number(slot1Lv[28]) === 0) && <img src="https://gateway.commudao.xyz/ipfs/bafybeibx4jdpjujrjqbax7megps3n2ynkh2sxcbpuiyvme4xlcmrs5nvnu?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[28]) >= 1 && Number(slot1Lv[28]) <= 5) && <img src="https://gateway.commudao.xyz/ipfs/bafybeig2mzbeg2kt3jzlqjwbhso42kok37nmckm67ndtexjjl5abatigye?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[28]) >= 6 && Number(slot1Lv[28]) <= 10) && <img src="https://gateway.commudao.xyz/ipfs/Qmf7bVQFwz8tQ1eVJBqcMkq3jY4BQvDfdnZgLBY26Fb5RX?img-width=400&img-height=400" width="120" alt="HOUSE.LV.6" />}
                    </div>
                ...
                <div id="tile54" className='emp tile' style={{position: "relative", width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column",  justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "#fff"}} onClick={() => {callMode(45); navigate('/community/cm-city/c15');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}>
                        {(slot1Lv !== null && Number(slot1Lv[37]) === 0) && <img src="https://gateway.commudao.xyz/ipfs/bafybeibx4jdpjujrjqbax7megps3n2ynkh2sxcbpuiyvme4xlcmrs5nvnu?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[37]) >= 1 && Number(slot1Lv[37]) <= 5) && <img src="https://gateway.commudao.xyz/ipfs/bafybeig2mzbeg2kt3jzlqjwbhso42kok37nmckm67ndtexjjl5abatigye?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[37]) >= 6 && Number(slot1Lv[37]) <= 10) && <img src="https://gateway.commudao.xyz/ipfs/Qmf7bVQFwz8tQ1eVJBqcMkq3jY4BQvDfdnZgLBY26Fb5RX?img-width=400&img-height=400" width="120" alt="HOUSE.LV.6" />}
                    </div>
                ...
                <div id="tile62" className='emp tile' style={{position: "relative", width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column",  justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "#fff"}} onClick={() => {callMode(45); navigate('/community/cm-city/c21');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}>
                        {(slot1Lv !== null && Number(slot1Lv[43]) === 0) && <img src="https://gateway.commudao.xyz/ipfs/bafybeibx4jdpjujrjqbax7megps3n2ynkh2sxcbpuiyvme4xlcmrs5nvnu?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[43]) >= 1 && Number(slot1Lv[43]) <= 5) && <img src="https://gateway.commudao.xyz/ipfs/bafybeig2mzbeg2kt3jzlqjwbhso42kok37nmckm67ndtexjjl5abatigye?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[43]) >= 6 && Number(slot1Lv[43]) <= 10) && <img src="https://gateway.commudao.xyz/ipfs/Qmf7bVQFwz8tQ1eVJBqcMkq3jY4BQvDfdnZgLBY26Fb5RX?img-width=400&img-height=400" width="120" alt="HOUSE.LV.6" />}
                    </div>
                ...
                <div id="tile7" className='emp tile' style={{position: "relative", width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column",  justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "#fff"}} onClick={() => {callMode(45); navigate('/community/cm-city/a03');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}>
                        {(slot1Lv !== null && Number(slot1Lv[2]) === 0) && <img src="https://gateway.commudao.xyz/ipfs/bafybeibx4jdpjujrjqbax7megps3n2ynkh2sxcbpuiyvme4xlcmrs5nvnu?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[2]) >= 1 && Number(slot1Lv[2]) <= 5) && <img src="https://gateway.commudao.xyz/ipfs/bafybeig2mzbeg2kt3jzlqjwbhso42kok37nmckm67ndtexjjl5abatigye?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[2]) >= 6 && Number(slot1Lv[2]) <= 10) && <img src="https://gateway.commudao.xyz/ipfs/Qmf7bVQFwz8tQ1eVJBqcMkq3jY4BQvDfdnZgLBY26Fb5RX?img-width=400&img-height=400" width="120" alt="HOUSE.LV.6" />}
                    </div>
                ...
                <div id="tile15" className='emp tile' style={{position: "relative", width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column",  justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "#fff"}} onClick={() => {callMode(45); navigate('/community/cm-city/a10');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}>
                        {(slot1Lv !== null && Number(slot1Lv[9]) === 0) && <img src="https://gateway.commudao.xyz/ipfs/bafybeibx4jdpjujrjqbax7megps3n2ynkh2sxcbpuiyvme4xlcmrs5nvnu?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[9]) >= 1 && Number(slot1Lv[9]) <= 5) && <img src="https://gateway.commudao.xyz/ipfs/bafybeig2mzbeg2kt3jzlqjwbhso42kok37nmckm67ndtexjjl5abatigye?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[9]) >= 6 && Number(slot1Lv[9]) <= 10) && <img src="https://gateway.commudao.xyz/ipfs/Qmf7bVQFwz8tQ1eVJBqcMkq3jY4BQvDfdnZgLBY26Fb5RX?img-width=400&img-height=400" width="120" alt="HOUSE.LV.6" />}
                    </div>
                ...
                <div id="tile23" className='emp tile' style={{position: "relative", width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column",  justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "#fff"}} onClick={() => {callMode(45); navigate('/community/cm-city/b06');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}>
                        {(slot1Lv !== null && Number(slot1Lv[16]) === 0) && <img src="https://gateway.commudao.xyz/ipfs/bafybeibx4jdpjujrjqbax7megps3n2ynkh2sxcbpuiyvme4xlcmrs5nvnu?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[16]) >= 1 && Number(slot1Lv[16]) <= 5) && <img src="https://gateway.commudao.xyz/ipfs/bafybeig2mzbeg2kt3jzlqjwbhso42kok37nmckm67ndtexjjl5abatigye?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[16]) >= 6 && Number(slot1Lv[16]) <= 10) && <img src="https://gateway.commudao.xyz/ipfs/Qmf7bVQFwz8tQ1eVJBqcMkq3jY4BQvDfdnZgLBY26Fb5RX?img-width=400&img-height=400" width="120" alt="HOUSE.LV.6" />}
                    </div>
                ...
                <div id="tile31" className='emp tile' style={{position: "relative", width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column",  justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "#fff"}} onClick={() => {callMode(45); navigate('/community/cm-city/b10');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}>
                        {(slot1Lv !== null && Number(slot1Lv[21]) === 0) && <img src="https://gateway.commudao.xyz/ipfs/bafybeibx4jdpjujrjqbax7megps3n2ynkh2sxcbpuiyvme4xlcmrs5nvnu?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[21]) >= 1 && Number(slot1Lv[21]) <= 5) && <img src="https://gateway.commudao.xyz/ipfs/bafybeig2mzbeg2kt3jzlqjwbhso42kok37nmckm67ndtexjjl5abatigye?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[21]) >= 6 && Number(slot1Lv[21]) <= 10) && <img src="https://gateway.commudao.xyz/ipfs/Qmf7bVQFwz8tQ1eVJBqcMkq3jY4BQvDfdnZgLBY26Fb5RX?img-width=400&img-height=400" width="120" alt="HOUSE.LV.6" />}
                    </div>
                ...
                <div id="tile39" className='emp tile' style={{position: "relative", width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column",  justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "#fff"}} onClick={() => {callMode(45); navigate('/community/cm-city/c07');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}>
                        {(slot1Lv !== null && Number(slot1Lv[29]) === 0) && <img src="https://gateway.commudao.xyz/ipfs/bafybeibx4jdpjujrjqbax7megps3n2ynkh2sxcbpuiyvme4xlcmrs5nvnu?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[29]) >= 1 && Number(slot1Lv[29]) <= 5) && <img src="https://gateway.commudao.xyz/ipfs/bafybeig2mzbeg2kt3jzlqjwbhso42kok37nmckm67ndtexjjl5abatigye?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[29]) >= 6 && Number(slot1Lv[29]) <= 10) && <img src="https://gateway.commudao.xyz/ipfs/Qmf7bVQFwz8tQ1eVJBqcMkq3jY4BQvDfdnZgLBY26Fb5RX?img-width=400&img-height=400" width="120" alt="HOUSE.LV.6" />}
                    </div>
                ...
                <div id="tile63" className="emp tile" style={{width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column", justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "rgb(0, 227, 180)"}} onClick={() => {callMode(43); navigate('/community/dumpster-hill');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}><img src="https://gateway.commudao.xyz/ipfs/bafybeia7e5mzmszg7heigxfzthkmhnnk555hw35jygufvpomiolp5lab3i?img-width=400&img-height=400" width="120" alt="Can't load metadata" /></div>
                ...
                <div id="tile8" className='emp tile' style={{position: "relative", width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column",  justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "#fff"}} onClick={() => {callMode(45); navigate('/community/cm-city/a04');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}>
                        {(slot1Lv !== null && Number(slot1Lv[3]) === 0) && <img src="https://gateway.commudao.xyz/ipfs/bafybeibx4jdpjujrjqbax7megps3n2ynkh2sxcbpuiyvme4xlcmrs5nvnu?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[3]) >= 1 && Number(slot1Lv[3]) <= 5) && <img src="https://gateway.commudao.xyz/ipfs/bafybeig2mzbeg2kt3jzlqjwbhso42kok37nmckm67ndtexjjl5abatigye?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[3]) >= 6 && Number(slot1Lv[3]) <= 10) && <img src="https://gateway.commudao.xyz/ipfs/Qmf7bVQFwz8tQ1eVJBqcMkq3jY4BQvDfdnZgLBY26Fb5RX?img-width=400&img-height=400" width="120" alt="HOUSE.LV.6" />}
                    </div>
                ...
                <div id="tile16" className='emp tile' style={{position: "relative", width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column",  justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "#fff"}} onClick={() => {callMode(45); navigate('/community/cm-city/a11');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}>
                        {(slot1Lv !== null && Number(slot1Lv[10]) === 0) && <img src="https://gateway.commudao.xyz/ipfs/bafybeibx4jdpjujrjqbax7megps3n2ynkh2sxcbpuiyvme4xlcmrs5nvnu?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[10]) >= 1 && Number(slot1Lv[10]) <= 5) && <img src="https://gateway.commudao.xyz/ipfs/bafybeig2mzbeg2kt3jzlqjwbhso42kok37nmckm67ndtexjjl5abatigye?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[10]) >= 6 && Number(slot1Lv[10]) <= 10) && <img src="https://gateway.commudao.xyz/ipfs/Qmf7bVQFwz8tQ1eVJBqcMkq3jY4BQvDfdnZgLBY26Fb5RX?img-width=400&img-height=400" width="120" alt="HOUSE.LV.6" />}
                    </div>
                ...
                <div id="tile24" className='emp tile' style={{position: "relative", width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column",  justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "#fff"}} onClick={() => {callMode(45); navigate('/community/cm-city/b07');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}>
                        {(slot1Lv !== null && Number(slot1Lv[17]) === 0) && <img src="https://gateway.commudao.xyz/ipfs/bafybeibx4jdpjujrjqbax7megps3n2ynkh2sxcbpuiyvme4xlcmrs5nvnu?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[17]) >= 1 && Number(slot1Lv[17]) <= 5) && <img src="https://gateway.commudao.xyz/ipfs/bafybeig2mzbeg2kt3jzlqjwbhso42kok37nmckm67ndtexjjl5abatigye?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[17]) >= 6 && Number(slot1Lv[17]) <= 10) && <img src="https://gateway.commudao.xyz/ipfs/Qmf7bVQFwz8tQ1eVJBqcMkq3jY4BQvDfdnZgLBY26Fb5RX?img-width=400&img-height=400" width="120" alt="HOUSE.LV.6" />}
                    </div>
                ...
                <div id="tile32" className='emp tile' style={{position: "relative", width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column",  justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "#fff"}} onClick={() => {callMode(45); navigate('/community/cm-city/b11');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}>
                        {(slot1Lv !== null && Number(slot1Lv[22]) === 0) && <img src="https://gateway.commudao.xyz/ipfs/bafybeibx4jdpjujrjqbax7megps3n2ynkh2sxcbpuiyvme4xlcmrs5nvnu?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[22]) >= 1 && Number(slot1Lv[22]) <= 5) && <img src="https://gateway.commudao.xyz/ipfs/bafybeig2mzbeg2kt3jzlqjwbhso42kok37nmckm67ndtexjjl5abatigye?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[22]) >= 6 && Number(slot1Lv[22]) <= 10) && <img src="https://gateway.commudao.xyz/ipfs/Qmf7bVQFwz8tQ1eVJBqcMkq3jY4BQvDfdnZgLBY26Fb5RX?img-width=400&img-height=400" width="120" alt="HOUSE.LV.6" />}
                    </div>
                ...
                <div id="tile40" className='emp tile' style={{position: "relative", width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column",  justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "#fff"}} onClick={() => {callMode(45); navigate('/community/cm-city/c08');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}>
                        {(slot1Lv !== null && Number(slot1Lv[30]) === 0) && <img src="https://gateway.commudao.xyz/ipfs/bafybeibx4jdpjujrjqbax7megps3n2ynkh2sxcbpuiyvme4xlcmrs5nvnu?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[30]) >= 1 && Number(slot1Lv[30]) <= 5) && <img src="https://gateway.commudao.xyz/ipfs/bafybeig2mzbeg2kt3jzlqjwbhso42kok37nmckm67ndtexjjl5abatigye?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[30]) >= 6 && Number(slot1Lv[30]) <= 10) && <img src="https://gateway.commudao.xyz/ipfs/Qmf7bVQFwz8tQ1eVJBqcMkq3jY4BQvDfdnZgLBY26Fb5RX?img-width=400&img-height=400" width="120" alt="HOUSE.LV.6" />}
                    </div>
                ...
                <div id="tile48" className='emp tile' style={{position: "relative", width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column",  justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "#fff"}} onClick={() => {callMode(45); navigate('/community/cm-city/c11');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}>
                        {(slot1Lv !== null && Number(slot1Lv[33]) === 0) && <img src="https://gateway.commudao.xyz/ipfs/bafybeibx4jdpjujrjqbax7megps3n2ynkh2sxcbpuiyvme4xlcmrs5nvnu?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[33]) >= 1 && Number(slot1Lv[33]) <= 5) && <img src="https://gateway.commudao.xyz/ipfs/bafybeig2mzbeg2kt3jzlqjwbhso42kok37nmckm67ndtexjjl5abatigye?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[33]) >= 6 && Number(slot1Lv[3]) <= 10) && <img src="https://gateway.commudao.xyz/ipfs/Qmf7bVQFwz8tQ1eVJBqcMkq3jY4BQvDfdnZgLBY26Fb5RX?img-width=400&img-height=400" width="120" alt="HOUSE.LV.6" />}
                    </div>
                ...
                <div id="tile56" className='emp tile' style={{position: "relative", width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column",  justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "#fff"}} onClick={() => {callMode(45); navigate('/community/cm-city/c16');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}>
                        {(slot1Lv !== null && Number(slot1Lv[38]) === 0) && <img src="https://gateway.commudao.xyz/ipfs/bafybeibx4jdpjujrjqbax7megps3n2ynkh2sxcbpuiyvme4xlcmrs5nvnu?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[38]) >= 1 && Number(slot1Lv[38]) <= 5) && <img src="https://gateway.commudao.xyz/ipfs/bafybeig2mzbeg2kt3jzlqjwbhso42kok37nmckm67ndtexjjl5abatigye?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[38]) >= 6 && Number(slot1Lv[38]) <= 10) && <img src="https://gateway.commudao.xyz/ipfs/Qmf7bVQFwz8tQ1eVJBqcMkq3jY4BQvDfdnZgLBY26Fb5RX?img-width=400&img-height=400" width="120" alt="HOUSE.LV.6" />}
                    </div>
                ...
                <div id="tile64" className='emp tile' style={{position: "relative", width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", display: "flex", flexDirection: "column",  justifyContent: "flex-end", alignItems: "center", cursor: "pointer", color: "#fff"}} onClick={() => {callMode(45); navigate('/community/cm-city/c22');}}>
                    <div style={{height: "80px", display: "flex", alignItems: "flex-end"}}>
                        {(slot1Lv !== null && Number(slot1Lv[44]) === 0) && <img src="https://gateway.commudao.xyz/ipfs/bafybeibx4jdpjujrjqbax7megps3n2ynkh2sxcbpuiyvme4xlcmrs5nvnu?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[44]) >= 1 && Number(slot1Lv[44]) <= 5) && <img src="https://gateway.commudao.xyz/ipfs/bafybeig2mzbeg2kt3jzlqjwbhso42kok37nmckm67ndtexjjl5abatigye?img-width=400&img-height=400" width="120" alt="Can't load metadata" />}
                        {(slot1Lv !== null && Number(slot1Lv[44]) >= 6 && Number(slot1Lv[44]) <= 10) && <img src="https://gateway.commudao.xyz/ipfs/Qmf7bVQFwz8tQ1eVJBqcMkq3jY4BQvDfdnZgLBY26Fb5RX?img-width=400&img-height=400" width="120" alt="HOUSE.LV.6" />}
                    </div>
