        ...
        <div style={{background: "rgb(0, 19, 33)", margin: "0", padding: "75px 0", minHeight: "inherit"}} className="collection pixel">
            ...
            <div style={{padding: 0, borderRadius: 0, border: "1px solid rgb(54, 77, 94)", background: "rgb(0, 26, 44)", width: "1216px", maxWidth: "78%", height: "1216px", display: "flex", flexDirection: "row", justifyContent: "flex-start", alignItems: "flex-start", flexWrap: "wrap", overflow: "scroll"}} className="nftCard noscroll">
                <div id="tile1" style={{width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center"}}>
                    <img src="https://nftstorage.link/ipfs/bafybeia3t2y63u3viivkwdcaekc7y6mmb745mdckkhvf4zhr273dkxw3gq" width="120" alt="Can't load metadata" />
                ...
                <div id="tile44" className="emp tile" style={{width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", cursor: "pointer", color: "rgb(0, 227, 180)"}} onClick={() => {callMode(44); navigate('/community/quester-oasis');}}>
                    <i style={{fontSize: "65px"}} className="fas fa-campground"></i>
                ...
                <div id="tile63" className="emp tile" style={{width: "150px", height: "150px", border: "1px solid rgb(54, 77, 94)", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", cursor: "pointer", color: "rgb(0, 227, 180)"}} onClick={() => {callMode(43); navigate('/community/dumpster-hill');}}>
                    <i style={{fontSize: "65px"}} className="fas fa-mountain"></i>
