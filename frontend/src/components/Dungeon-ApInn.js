...
const ApInn = ({ setisLoading, txupdate, setTxupdate, acUpgradeABI, uniEnchanterABI, erc721ABI, erc20ABI, questAmbassABI, cmdaoNameABI, dunAngbABI }) => {
    ...
    React.useEffect(() => {
        ...
        const thefetch = async () => {
            ...
            const spend1Event = await angbFarmSC.queryFilter(spend1Filter, 3371322, 'latest')
            ...
            const spend2Event = await vabagUsageSC.queryFilter(spend2Filter, 3371322, 'latest')
            ...
            const spend31Event = await acnftSC.queryFilter(spend31Filter, 3371322, 'latest')
            ...
            const spend32Event = await apDunSC.queryFilter(spend32Filter, 3371322, 'latest')
            ...
            const spend33Event = await apDunSC.queryFilter(spend33Filter, 3371322, 'latest')
