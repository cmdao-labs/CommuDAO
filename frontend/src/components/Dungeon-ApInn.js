...
const ApInn = ({ config, setisLoading, navigate, callMode, txupdate, setTxupdate, setisError, setErrMsg, acUpgradeABI, uniEnchanterABI, erc721Abi, erc20Abi, questAmbassABI, cmdaoNameABI, dunAngbABI }) => {
    ...
    React.useEffect(() => {
        ...
        const thefetch = async () => {
            ...
            const spend1Event = await angbFarmSC.queryFilter(spend1Filter, 4300992, 'latest')
            ...
            const spend2Event = await vabagUsageSC.queryFilter(spend2Filter, 4300992, 'latest')
            ...
            const spend31Event = await acnftSC.queryFilter(spend31Filter, 4300992, 'latest')
            ...
            const spend32Event = await apDunSC.queryFilter(spend32Filter, 4300992, 'latest')
            ...
            const spend33Event = await apDunSC.queryFilter(spend33Filter, 4300992, 'latest')
