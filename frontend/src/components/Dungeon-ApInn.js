...
const ApInn = ({ config, setisLoading, navigate, callMode, txupdate, setTxupdate, setisError, setErrMsg, acUpgradeABI, uniEnchanterABI, erc721Abi, erc20Abi, questAmbassABI, cmdaoNameABI, dunAngbABI }) => {
    ...
    React.useEffect(() => {
        ...
        const thefetch = async () => {
            ...
            const spend1Event = await angbFarmSC.queryFilter(spend1Filter, 4475889, 'latest')
            ...
            const spend2Event = await vabagUsageSC.queryFilter(spend2Filter, 4475889, 'latest')
            ...
            const spend31Event = await acnftSC.queryFilter(spend31Filter, 4475889, 'latest')
            ...
            const spend32Event = await apDunSC.queryFilter(spend32Filter, 4475889, 'latest')
            ...
            const spend33Event = await apDunSC.queryFilter(spend33Filter, 4475889, 'latest')
    ...
    return (
        <>
            <div className="fieldBanner" style={{display: "flex", flexFlow: "row wrap", alignItems: "center", justifyContent: "space-between", textAlign: "left", overflow: "scroll"}}>
                ...
                <div className="SubfieldBanner">
                    <img src="https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeifrqslsoes7swzc3bnjl72x6sgsewcnx2w3zjsm5pzma7ku2onr6a" height="200" alt="AP-INN" />
                </div>
            </div>
                ...
                <div style={{width: "90%", display: "flex", flexDirection: "row", justifyContent: "space-between", flexWrap: "wrap", overflow: "scroll"}} className="noscroll">
                    <div style={{maxWidth: "100%", textAlign: "left", marginTop: "50px", display: "flex", flexDirection: "column", justifyContent: "flex-start"}}>
                        ...
                        <div style={{display: "flex", flexDirection: "row", justifyContent: "flex-start", overflow: "scroll"}} className="noscroll pixel">
                            ...
                            <div style={{width: "200px", minWidth: "200px", height: "55px", margin: "20px 10px 20px 0", fontSize: "15px", border: "1px solid #dddade", boxShadow: "3px 3px 0 #dddade"}} className="items">
                                <img src="https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafkreiev2kbirflwhlqbwd6zh6trd7gx62tijviekwewd6zaogm4vzrh7m" width="22" alt="$ANGB"/>
                                <div style={{marginLeft: "10px"}}>{Number(angbBalance).toLocaleString('en-US', {maximumFractionDigits:3})}</div>
                            </div>
                            <div style={{width: "200px", minWidth: "200px", height: "55px", margin: "20px 10px 20px 0", fontSize: "15px", border: "1px solid #dddade", boxShadow: "3px 3px 0 #dddade"}} className="items">
                                <img src="https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeideve73vg6mtnwzjjmrol66idxoe3orfxrjbdairhwbumyj3a46eu" width="22" alt="$STAR"/>
                    ...
                    <div style={{textAlign: "left", margin: "20px 0 80px 0", minHeight: "600px", width: "100%", display: "flex", flexDirection: "column", justifyContent: "flex-start"}}>
                        <div style={{padding: "50px", backdropFilter: "blur(20px)", border: "none", width: "940px", maxWidth: "75%", height: "300px", display: "flex", flexDirection: "column", justifyContent: "space-around", alignItems: "center", flexWrap: "wrap", fontSize: "14px"}} className="nftCard">
                            <div style={{width: "98%", fontSize: "30px"}}>December 2024 Prize Pool 🎁</div>
                                                    ...
                                                    <div style={{justifyContent: "space-around", padding: "30px", marginRight: "50px"}} className="nftCard">
                                                        <div className="emp pixel" style={{marginTop: "10px", width: "350px", display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-between"}}>
                                                            ...
                                                            {String(item.Id).slice(0, 3) === "101" &&
                                                                <div>
                                                                    <video muted loop width="120" style={{alignSelf: "flex-start", marginTop: "20px"}}>
                                                                        <source src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeifsfdjwelvtzg6nurhgterfyfw6fyvoessptriej4yip4vq3xt6ze' type="video/mp4" />
                                                                    </video>
                                                            ...
                                                            {String(item.Id).slice(0, 3) === "102" &&
                                                                <div>
                                                                    <video muted loop width="120" style={{alignSelf: "flex-start", marginTop: "20px"}}>
                                                                        <source src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeig6nfhwxb6apgwjpina3w3ltlfss2vgmn7e6loguf3db7z6yp6ofe' type="video/mp4" />
                                                                    </video>
                                                            ...
                                                            {String(item.Id).slice(0, 3) === "103" &&
                                                                <div>
                                                                    <video muted loop width="120" style={{alignSelf: "flex-start", marginTop: "20px"}}>
                                                                        <source src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeidvfdvw6mc2pln5wo7hstyl2pa6mwkvpdqi2onuam3uht6fnt23ui' type="video/mp4" />
                                                                    </video>
                                                            ...
                                                            {String(item.Id).slice(0, 3) === "104" &&
                                                                <div>
                                                                    <video muted loop width="120" style={{alignSelf: "flex-start", marginTop: "20px"}}>
                                                                        <source src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeiesy2tb3rk2xfnhe6sxpeoerwqfpelrjmeypisgr23ci7ifokjm5q' type="video/mp4" />
                                                                    </video>
                                                            ...
                                                            {String(item.Id).slice(0, 3) === "105" &&
                                                                <div>
                                                                    <video muted loop width="120" style={{alignSelf: "flex-start", marginTop: "20px"}}>
                                                                        <source src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeifqigkbjup3auor6puownvf2myhsxgogvp2rypacgpwi75juvqsae' type="video/mp4" />
                                                                    </video>
                                                            ...
                                                            {String(item.Id).slice(0, 3) === "201" &&
                                                                <div>
                                                                    <video muted loop width="120" style={{alignSelf: "flex-start", marginTop: "20px"}}>
                                                                        <source src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeigso6gthqx37ok66bhtn4iwva5a3dvfummbdgfj5kjfosusqohfpu' type="video/mp4" />
                                                                    </video>
                                                                    <div style={{width: "150px"}}>{item.Name.slice(0, -1)}1</div>
                                                                </div>
                                                            }
                                                            {String(item.Id).slice(0, 3) === "202" &&
                                                                <div>
                                                                    <video muted loop width="120" style={{alignSelf: "flex-start", marginTop: "20px"}}>
                                                                        <source src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeidfn7btigokkuont2mjbwk377hp3ipgdffkqwp7etwhghvb7opspq' type="video/mp4" />
                                                                    </video>
                                                                    <div style={{width: "150px"}}>{item.Name.slice(0, -1)}2</div>
                                                                </div>
                                                            }
                                                            {String(item.Id).slice(0, 3) === "203" &&
                                                                <div>
                                                                    <video muted loop width="120" style={{alignSelf: "flex-start", marginTop: "20px"}}>
                                                                        <source src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeid37zvuwqumg45v4saisweceuxo7ukw4pa7rineghonfcndaa3yju' type="video/mp4" />
                                                                    </video>
                                                                    <div style={{width: "150px"}}>{item.Name.slice(0, -1)}3</div>
                                                                </div>
                                                            }
                                                            {String(item.Id).slice(0, 3) === "204" &&
                                                                <div>
                                                                    <video muted loop width="120" style={{alignSelf: "flex-start", marginTop: "20px"}}>
                                                                        <source src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeig3ilnnbbu5leurojtvtj44md6vt7paubqcgzddggmvnrj2qs7pzy' type="video/mp4" />
                                                                    </video>
                                                                    <div style={{width: "150px"}}>{item.Name.slice(0, -1)}4</div>
                                                                </div>
                                                            }
                                                            {String(item.Id).slice(0, 3) === "205" &&
                                                                <div>
                                                                    <video muted loop width="120" style={{alignSelf: "flex-start", marginTop: "20px"}}>
                                                                        <source src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeia22spf73265h7zwq3rlydayzhmksbmhpjn2ppncnpbuswigadj2e' type="video/mp4" />
                                                                    </video>
                                                            ...
                                                            {String(item.Id).slice(0, 3) === "301" &&
                                                                <div>
                                                                    <video muted loop width="120" style={{alignSelf: "flex-start", marginTop: "20px"}}>
                                                                        <source src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeihs2ydvod22xncp3264pvybcxi6njid7ncqbrz2e4qkl6mresb6yq' type="video/mp4" />
                                                                    </video>
                                                                    <div style={{width: "150px"}}>{item.Name.slice(0, -1)}1</div>
                                                                </div>
                                                            }
                                                            {String(item.Id).slice(0, 3) === "302" &&
                                                                <div>
                                                                    <video muted loop width="120" style={{alignSelf: "flex-start", marginTop: "20px"}}>
                                                                        <source src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeifc7ffb7n2ytc7lfohcy3k6qgkfsz5t5jwbwpd552pkztamm7uuli' type="video/mp4" />
                                                                    </video>
                                                                    <div style={{width: "150px"}}>{item.Name.slice(0, -1)}2</div>
                                                                </div>
                                                            }
                                                            {String(item.Id).slice(0, 3) === "303" &&
                                                                <div>
                                                                    <video muted loop width="120" style={{alignSelf: "flex-start", marginTop: "20px"}}>
                                                                        <source src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeid2jukb33diwjv4p6ia4sg6zkdrd6rhbcy6nemlvnqhel3zesoqni' type="video/mp4" />
                                                                    </video>
                                                                    <div style={{width: "150px"}}>{item.Name.slice(0, -1)}3</div>
                                                                </div>
                                                            }
                                                            {String(item.Id).slice(0, 3) === "304" &&
                                                                <div>
                                                                    <video muted loop width="120" style={{alignSelf: "flex-start", marginTop: "20px"}}>
                                                                        <source src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeigvvbgvxsluftnkedcw2vwfaw5rarbhyonrwsvqh2rr3du7ndxzwa' type="video/mp4" />
                                                                    </video>
                                                                    <div style={{width: "150px"}}>{item.Name.slice(0, -1)}4</div>
                                                                </div>
                                                            }
                                                            {String(item.Id).slice(0, 3) === "305" &&
                                                                <div>
                                                                    <video muted loop width="120" style={{alignSelf: "flex-start", marginTop: "20px"}}>
                                                                        <source src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeigvqwas5ph2qwfmlo5riqvnul7stnw5fbg2igqto55fgkqijciezi' type="video/mp4" />
                                                                    </video>
                                                    ...
                                                    <div style={{justifyContent: "space-around", padding: "30px", marginRight: "50px"}} className="nftCard">
                                                        <div className="emp pixel" style={{marginTop: "10px", width: "350px", display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-between"}}>
                                                            ...
                                                            {Number(item.Id) % 100000 === 300 &&
                                                                <div>
                                                                    <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeia5odwzbuvz2obwvrau5jasz4vdalveei4vjypohy6hghy3i5py6i' width="120" alt="Can not load metadata." />
                                                                    <div style={{width: "150px"}}>{item.Name.slice(0, -1)}3</div>
                                                                </div>
                                                            }
                                                            {Number(item.Id) % 100000 === 500 &&
                                                                <div>
                                                                    <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeiaoaneuefkfhvx4rhn4dclohrwettfn2amuedykhuc5o2t4dtpohu' width="120" alt="Can not load metadata." />
                                                                    <div style={{width: "150px"}}>{item.Name.slice(0, -1)}5</div>
                                                                </div>
                                                            }
                                                            {Number(item.Id) % 100000 === 700 &&
                                                                <div>
                                                                    <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeiej4wn5irshklfurszij65hwzquap7xh2lzvx46fxkkjhcryz6zua' width="120" alt="Can not load metadata." />
                                                                    <div style={{width: "150px"}}>{item.Name.slice(0, -1)}7</div>
                                                                </div>
                                                            }
                                                            {Number(item.Id) % 100000 === 900 &&
                                                                <div>
                                                                    <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeift6v2ao2t4uyj6lghhnjh4xb7glphvmloyqdkeie2nu3hisf2pf4' width="120" alt="Can not load metadata." />
                                                    ...
                                                    <div style={{justifyContent: "space-around", padding: "30px", marginRight: "50px"}} className="nftCard">
                                                        <div className="emp pixel" style={{marginTop: "10px", width: "350px", display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-between"}}>
                                                            ...
                                                            {Number(item.Id) % 100000 === 250 &&
                                                                <div>
                                                                    {String(item.Id).slice(0, 3) === "700" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeidxnerdssvoads33qf5klz2gxx6c5f3pjkwleyyasxkr4d2fhddo4' width="120" alt="Can not load metadata." />}
                                                                    {String(item.Id).slice(0, 3) === "500" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeiavljudr364wnbra3glwvxx63emaawoti7o7uvdkfq6byre33k3by' width="120" alt="Can not load metadata." />}
                                                                    {String(item.Id).slice(0, 3) === "300" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeifo6h2grxkhkhezqjpqj72dmwjwjumpglb75epnhkg5kmukkaegxa' width="120" alt="Can not load metadata." />}
                                                                    {String(item.Id).slice(0, 3) === "200" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeidkwd67x7cuggzykl2s7az7adadu657hjq3rthvkb7wtjqyno4sxq' width="120" alt="Can not load metadata." />}
                                                                    {String(item.Id).slice(0, 3) === "600" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeibwn7pyxxduc54giiujmc2lm2kv7twwcbxkmyrtm24d74wz4auryu' width="120" alt="Can not load metadata." />}
                                                                    {String(item.Id).slice(0, 3) === "400" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeigzllo7efbaroebrlp6uyi7j6xobyolgreimecdz2zumk5ft5scjy' width="120" alt="Can not load metadata." />}
                                                                    <div style={{width: "150px"}}>{item.Name} +1</div>
                                                                </div>
                                                            }
                                                            {Number(item.Id) % 100000 === 300 &&
                                                                <div>
                                                                    {String(item.Id).slice(0, 3) === "700" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafkreib5o6ewz4uyjs4tnnwrwmc65phsro6iqkjo5zfny56huw76ew4jwu' width="120" alt="Can not load metadata." />}
                                                                    {String(item.Id).slice(0, 3) === "500" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeid57rinqklnxolfiro5yq2izqgr43k7tpo5trmewstp6h7aurp3ma' width="120" alt="Can not load metadata." />}
                                                                    {String(item.Id).slice(0, 3) === "300" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeidex5aijsbmwidybwzjpbbnyxwmdpebehgmp2r5wlw3brg3c7zoeq' width="120" alt="Can not load metadata." />}
                                                                    {String(item.Id).slice(0, 3) === "200" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeihal22c662yiosvtnrh7fsoqpie3jusfsqmpeo4jhwthineclx7q4' width="120" alt="Can not load metadata." />}
                                                                    {String(item.Id).slice(0, 3) === "600" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeieh2jb2d527n4uummwxe7t36vjfhspv2opoxoqfrmxvzhziiukbs4' width="120" alt="Can not load metadata." />}
                                                                    {String(item.Id).slice(0, 3) === "400" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeihnkzlzlddkvsdgbcq2umejivaznqmdohng3vccvauwyc2bu7vt4q' width="120" alt="Can not load metadata." />}
                                                                    <div style={{width: "150px"}}>{item.Name.slice(0, -1)}2</div>
                                                                </div>
                                                            }
                                                            {Number(item.Id) % 100000 === 400 &&
                                                                <div>
                                                                    {String(item.Id).slice(0, 3) === "700" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafkreicfuyvprncafvvus4e7mpuqcmkqujznohke222tz5vzdqsnlqdvdu' width="120" alt="Can not load metadata." />}
                                                                    {String(item.Id).slice(0, 3) === "500" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafkreifd45rhblhwe5qvkvpctaamqjdviijt4olae3266gosuw4mqgx7su' width="120" alt="Can not load metadata." />}
                                                                    {String(item.Id).slice(0, 3) === "300" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeidwsyrf52coy3xxqlpw5thnqaaztsx7cdrwr2lwogzkp4gd4cbuwi' width="120" alt="Can not load metadata." />}
                                                                    {String(item.Id).slice(0, 3) === "200" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafkreia4n6c2srsjbqv555tewpo5hjt575fw2l4cjfwk64sqcwcvpdrebe' width="120" alt="Can not load metadata." />}
                                                                    {String(item.Id).slice(0, 3) === "600" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafkreieo765chiflk5msgydn5wxcmtqlf2sjfw5cuwpegnzzllyqhzcyci' width="120" alt="Can not load metadata." />}
                                                                    {String(item.Id).slice(0, 3) === "400" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafkreiftgfwgvdmbluidz5umixhvx5epxqpprtx3tq2dr2qh3gouoscgku' width="120" alt="Can not load metadata." />}
                                                                    <div style={{width: "150px"}}>{item.Name.slice(0, -1)}3</div>
                                                                </div>
                                                            }
                                                            {Number(item.Id) % 100000 === 500 &&
                                                                <div>
                                                                    {String(item.Id).slice(0, 3) === "700" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafkreictz33nfdbozdf67456m6ulo2mrcmsldpree744tyj7gsary42mge' width="120" alt="Can not load metadata." />}
                                                                    {String(item.Id).slice(0, 3) === "500" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafkreihezeecmvuj6cgse2rnc2tbzqrzeadxliuc3zzy2wxpfog5yv3cau' width="120" alt="Can not load metadata." />}
                                                                    {String(item.Id).slice(0, 3) === "300" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeicjghxuvreknriwduid7zw6zfsxj6px7te6m3ybpxhjglktldh5q4' width="120" alt="Can not load metadata." />}
                                                                    {String(item.Id).slice(0, 3) === "200" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafkreiedkyysocf56q2ykmmkismzvmlsp73b3e4wnxn2usmpislxvbfdue' width="120" alt="Can not load metadata." />}
                                                                    {String(item.Id).slice(0, 3) === "600" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafkreigutlmirjgjy6nwgluv3sk4y6noqmxkqbmf5qk4zoh4tayz42rqzq' width="120" alt="Can not load metadata." />}
                                                                    {String(item.Id).slice(0, 3) === "400" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafkreiepekxjkzsd3xg425mcgnktf4m3y2d7xcqenzhkh7quawxhjnycxi' width="120" alt="Can not load metadata." />}
                                                                    <div style={{width: "150px"}}>{item.Name.slice(0, -1)}4</div>
                                                                </div>
                                                            }
                                                            {Number(item.Id) % 100000 === 600 &&
                                                                <div>
                                                                    {String(item.Id).slice(0, 3) === "700" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeia52i47ftizdlnx77ekw7a3ncs2ahxiegxrlmci37a75vqcyyru6a' width="120" alt="Can not load metadata." />}
                                                                    {String(item.Id).slice(0, 3) === "500" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeibbakqgfnshw3jyyvbmymkuf5pylzrzseksfoo2rdhry6p7rrcbaq' width="120" alt="Can not load metadata." />}
                                                                    {String(item.Id).slice(0, 3) === "300" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeiglsjsqn6bibwx6s2ehtawhqwroxsmasguayvdl7tlujmvkvgks2q' width="120" alt="Can not load metadata." />}
                                                                    {String(item.Id).slice(0, 3) === "200" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeiho3m6yi3t45ljtufnlmq6xnkeeb4oz5lwjt5okwt5xkgwegb36v4' width="120" alt="Can not load metadata." />}
                                                                    {String(item.Id).slice(0, 3) === "600" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeidmncmt75ansjbsrkvk3ujhquemej5nlime3cn2rmpsdwb7zrzi3e' width="120" alt="Can not load metadata." />}
                                                                    {String(item.Id).slice(0, 3) === "400" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeibg7nlydlf6wv5ar7fzxuevqxwnzt3m7hzh3bta3z5khfz34wna3e' width="120" alt="Can not load metadata." />}
                                                                    <div style={{width: "150px"}}>{item.Name.slice(0, -1)}5</div>
                                                                </div>
                                                            }
                                                            {Number(item.Id) % 100000 === 700 &&
                                                                <div>
                                                                    {String(item.Id).slice(0, 3) === "700" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeibvhepypdky2enzjzlbqozpmwiq7wvuda2hah5g2umhefxudmn5iu' width="120" alt="Can not load metadata." />}
                                                                    {String(item.Id).slice(0, 3) === "500" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeiercameocvi6xiw5yuwvbhagk2ut7xa4pr3delbqg2fpfhsnwxwgu' width="120" alt="Can not load metadata." />}
                                                                    {String(item.Id).slice(0, 3) === "300" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeidgpxrzly3nqltvc4j6u4erni444th65szq2wsjrv66mas5qmcm34' width="120" alt="Can not load metadata." />}
                                                                    {String(item.Id).slice(0, 3) === "200" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeigk3yjgpmtlbwrj7wwd6wnaamzym6lzmbogorb7wpgfkhxvr3auw4' width="120" alt="Can not load metadata." />}
                                                                    {String(item.Id).slice(0, 3) === "600" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeic25z3kgp4qkqnkuyohof5vwj5hmdace5d2acqfk5tcw3qt2wtfiq' width="120" alt="Can not load metadata." />}
                                                                    {String(item.Id).slice(0, 3) === "400" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeigsluheodrvsyvrdwqpuyhabyicazpr5cb3zjrv3k4twj6awxnl2y' width="120" alt="Can not load metadata." />}
                                                                    <div style={{width: "150px"}}>{item.Name.slice(0, -1)}6</div>
                                                                </div>
                                                            }
                                                            {Number(item.Id) % 100000 === 800 &&
                                                                <div>
                                                                    {String(item.Id).slice(0, 3) === "700" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeif7siidbof5pzqmnpd337sksfaqhxd3f5iazcvne2nxv6rsoh2zum' width="120" alt="Can not load metadata." />}
                                                                    {String(item.Id).slice(0, 3) === "500" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeihzcpnug3w4jpqmoznarvxbpdjdpnzibj7a2bzvh2af3js3lk4ani' width="120" alt="Can not load metadata." />}
                                                                    {String(item.Id).slice(0, 3) === "300" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeifjnuyqckv6aalnd6mocxx6537gfrfixx2cswdq5oyqnyflm6qyuu' width="120" alt="Can not load metadata." />}
                                                                    {String(item.Id).slice(0, 3) === "200" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeibo5f5ceohspkwbgflpwcas5qfemgqtknpf4msuktkyaq7cxgvtji' width="120" alt="Can not load metadata." />}
                                                                    {String(item.Id).slice(0, 3) === "600" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeifvnvbsb5ou7b2tijqag2hxbfyrum6kdywe4hq7eea3cx34vr5j34' width="120" alt="Can not load metadata." />}
                                                                    {String(item.Id).slice(0, 3) === "400" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeigtt4qt7q2v4fyp6slkrl547aucsitljj6rpwcub5bhv237tp6zhu' width="120" alt="Can not load metadata." />}
                                                                    <div style={{width: "150px"}}>{item.Name.slice(0, -1)}7</div>
                                                                </div>
                                                            }
                                                            {Number(item.Id) % 100000 === 900 &&
                                                                <div>
                                                                    {String(item.Id).slice(0, 3) === "700" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeiaxzem2d65p43oy2l53jkmcycwmdrqerglw2qvu2otmzmkve2uw3a' width="120" alt="Can not load metadata." />}
                                                                    {String(item.Id).slice(0, 3) === "500" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeiacng6l2biwvphdlz3dqh6rknnjppanxdx2srvbrgfv67do3mi7wq' width="120" alt="Can not load metadata." />}
                                                                    {String(item.Id).slice(0, 3) === "300" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeihmyw5fcjxcwv3afaefsv4twlkgmovozluiqiq3xvdr2tod6cztbi' width="120" alt="Can not load metadata." />}
                                                                    {String(item.Id).slice(0, 3) === "200" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeicxcwrqutvfyjegcextgfq67txs7sg7dx33ck3huffeuq4x5ktmou' width="120" alt="Can not load metadata." />}
                                                                    {String(item.Id).slice(0, 3) === "600" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeigevydzpebgfubwxoitzii5kfn64zma7npqd55j3cwnjp6w3hbm64' width="120" alt="Can not load metadata." />}
                                                                    {String(item.Id).slice(0, 3) === "400" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeibwk3ijxpynuu2lar6vea2xf2ixh6nj2knbf5v62xqelak4k4hbxu' width="120" alt="Can not load metadata." />}
                                                                    <div style={{width: "150px"}}>{item.Name.slice(0, -1)}8</div>
                                                                </div>
                                                            }
                                                            {Number(item.Id) % 100000 === 1000 &&
                                                                <div>
                                                                    {String(item.Id).slice(0, 3) === "700" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeicqf3zmvxmazfgmgcxyuv64t2mckpgfzz6pc4mnplltb2pvv7ez7u' width="120" alt="Can not load metadata." />}
                                                                    {String(item.Id).slice(0, 3) === "500" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeifkfw2p65zmr3gop3p2uegldghj6vk455ezg33pelyl7jc3kuca3y' width="120" alt="Can not load metadata." />}
                                                                    {String(item.Id).slice(0, 3) === "300" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeic7c6pjxrge36iwwsvhiw4rdzy6z3exlea3mnnsjkupzfvcqojdk4' width="120" alt="Can not load metadata." />}
                                                                    {String(item.Id).slice(0, 3) === "200" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeib5wpqecdu2s65k4gktw7gdqgyxgrlpv44pszxxzyo65knnjwbwqi' width="120" alt="Can not load metadata." />}
                                                                    {String(item.Id).slice(0, 3) === "600" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeieg2gz5jgwjqpbihfy4pns6mwkjajcxiy3paxsciriz7wduzghhdq' width="120" alt="Can not load metadata." />}
                                                                    {String(item.Id).slice(0, 3) === "400" && <img src='https://apricot-secure-ferret-190.mypinata.cloud/ipfs/bafybeiaxljxw5nxp4gay4k3wtyra2axtird36gap6ekadxd2o5zaeqhx6i' width="120" alt="Can not load metadata." />}
                                                                    <div style={{width: "150px"}}>{item.Name.slice(0, -1)}9</div>
                                                                </div>
                                                            }
                                                        </div>
