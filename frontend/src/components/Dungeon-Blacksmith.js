                                            ...
                                            {String(item.Id).slice(0, 3) === "712" && Number(item.Id) % 100000 !== 1000 && Number(item.Id) % 100000 !== 4250 && Number(item.Id) % 100000 !== 14800 && Number(item.Id) % 100000 !== 25700 &&
                                                <div style={{justifyContent: "space-around", padding: "30px", marginRight: "50px"}} className="nftCard">
                                                    <div className="emp pixel" style={{marginTop: "10px", width: "350px", display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-between"}}>
                                                        ...
                                                        {Number(item.Id) % 100000 === 750 &&
                                                            <div>
                                                                <img width="120" src='https://bafybeibciwxuvtqp6ampxy5ulnpce5ds3fmtlg4f3lrdd7zbrqib44hx2q.ipfs.nftstorage.link/' alt="Can not load metadata." />
                                                                <div style={{width: "150px"}}>{item.Name.slice(0, -1)}3</div>
                                                            </div>
                                                        }
                                                        {Number(item.Id) % 100000 === 950 &&
                                                            <div>
                                                                <img width="120" src='https://bafybeicjh2j5bcbqiz6paytsnonrjw2g6qry3kuftjzvhf4tzv7z4w3s7e.ipfs.nftstorage.link/' alt="Can not load metadata." />
                                                                <div style={{width: "150px"}}>{item.Name.slice(0, -1)}2</div>
                                                            </div>
                                                        }
                                                        {Number(item.Id) % 100000 === 1450 &&
                                                        ...
                                                        {Number(item.Id) % 100000 === 2000 &&
                                                            <div>
                                                                <img width="120" src='https://bafybeiechrhufeyowo4ozj3cqr3ojsxstfyuuc63erfxnesoq7jjt23p54.ipfs.nftstorage.link/' alt="Can not load metadata." />
                                                                <div style={{width: "150px"}}>{item.Name.slice(0, -1)}4</div>
                                                            </div>
                                                        }
                                                        {(Number(item.Id) % 100000 === 2650 || Number(item.Id) % 100000 === 5250 || Number(item.Id) % 100000 === 7500) &&
                                                        ...
                                                        {Number(item.Id) % 100000 === 3400 &&
                                                            <div>
                                                                <img width="120" src='https://bafybeify7bktuh2uzxq4spekxtpg6wvcstoomcvnt2vfb5zuaz76cbht4i.ipfs.nftstorage.link/' alt="Can not load metadata." />
                                                                <div style={{width: "150px"}}>{item.Name.slice(0, -1)}6</div>
                                                            </div>
                                                        }
                                                        {Number(item.Id) % 100000 === 1800 &&
                                                            <div>
                                                                <img width="120" src='https://bafybeih2f3tx2zxbnnmcmxp7lt4syjt5wnygrithh5jwscuhxna3gfmvtq.ipfs.nftstorage.link/' alt="Can not load metadata." />
                                                                <div style={{width: "150px"}}>{item.Name.slice(0, -1)}2</div>
                                                            </div>
                                                        }
                                                        {(Number(item.Id) % 100000 === 2750 && Number(item.Id) % 100000 === 4600) &&
                                                        ...
                                                        {Number(item.Id) % 100000 === 3900 &&
                                                            <div>
                                                                <img width="120" src='https://bafybeihw5bfy7mr373yfo2acy5ywvvkm3es77j6wcskfwfgnzzzftlbgni.ipfs.nftstorage.link/' alt="Can not load metadata." />
                                                                <div style={{width: "150px"}}>{item.Name.slice(0, -1)}4</div>
                                                            </div>
                                                        }
                                                        {Number(item.Id) % 100000 === 6800 &&
                                                            <div>
                                                                <img width="120" src='https://bafybeiauywvcwiz4fciukscwvqqte3b2toit2kjy5xmh2ajyg2464g5iwq.ipfs.nftstorage.link/' alt="Can not load metadata." />
                                                                <div style={{width: "150px"}}>{item.Name.slice(0, -1)}6</div>
                                                            </div>
                                                        }
                                                        {(Number(item.Id) % 100000 === 8550 || Number(item.Id) % 100000 === 11200) &&
                                                        ...
                                                        {Number(item.Id) % 100000 === 10500 &&
                                                            <div>
                                                                <img width="120" src='https://bafybeigsjc76tydnh6d2trb2k3ponhocsuardmyt2bdz5ntdjpvduay5wu.ipfs.nftstorage.link/' alt="Can not load metadata." />
                                                                <div style={{width: "150px"}}>{item.Name.slice(0, -1)}8</div>
                                                            </div>
                                                        }
                                                        {Number(item.Id) % 100000 === 3450 &&
                                                            <div>
                                                                <img width="120" src='https://bafybeiexcsgagsi724i35ic7xfmckq3fhgsdu654cuinxfehtmjfovtxem.ipfs.nftstorage.link/' alt="Can not load metadata." />
                                                                <div style={{width: "150px"}}>{item.Name.slice(0, -1)}2</div>
                                                            </div>
                                                        }
                                                        {Number(item.Id) % 100000 === 5950 &&
                                                            <div>
                                                                <img width="120" src='https://bafybeieft73kqjz2yxgxpx7yrhttiqi2cqlj2jaccffmtfbtynf33za6hy.ipfs.nftstorage.link/' alt="Can not load metadata." />
                                                                <div style={{width: "150px"}}>{item.Name.slice(0, -1)}4</div>
                                                            </div>
                                                        }
                                                        {Number(item.Id) % 100000 === 9250 &&
                                                            <div>
                                                                <img width="120" src='https://bafybeib3e4xpotrtmi42rk7pp3upilcsxziaxkgk2pq3cfxdu73733vw4q.ipfs.nftstorage.link/' alt="Can not load metadata." />
                                                                <div style={{width: "150px"}}>{item.Name.slice(0, -1)}6</div>
                                                            </div>
                                                        }
                                                        {Number(item.Id) % 100000 === 13350 &&
                                                            <div>
                                                                <img width="120" src='https://bafybeibf4a6fmnpgd3vbfakmnhyyoryvwhvkwhnqepsco5vgikby57nr6e.ipfs.nftstorage.link/' alt="Can not load metadata." />
                                                                <div style={{width: "150px"}}>{item.Name.slice(0, -1)}8</div>
                                                            </div>
                                                        }
                                                        {Number(item.Id) % 100000 === 18050 &&
                                                            <div>
                                                                <img width="120" src='https://bafybeihivxsrsk4a4xsngo2a7cjdo4bppsdaakgq7t2zmng2wr23tsunie.ipfs.nftstorage.link/' alt="Can not load metadata." />
                                                                <div style={{width: "150px"}}>{item.Name.slice(0, -1)}9</div>
                                                            </div>
                                                        }
                                                    </div>
