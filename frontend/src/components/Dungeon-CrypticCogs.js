...
const CrypticCogs = ({ intrasubModetext, navigate, setisLoading, txupdate, setTxupdate, erc721ABI, erc20ABI, dunEEABI }) => {
    ...
    React.useEffect(() => {
        ...
        const thefetch = async () => {
            ...
            const response1 = charIpfs !== null ? await fetch(charIpfs.replace("ipfs://", providerIPFS)) : null
            ...
            const response2 = accIpfs !== null ? await fetch(accIpfs.replace("ipfs://", providerIPFS)) : null
            ...
            const response3 = backpfs !== null ? await fetch(backpfs.replace("ipfs://", providerIPFS)) : null
            ...
            const response4 = shoesIpfs !== null ? await fetch(shoesIpfs.replace("ipfs://", providerIPFS)) : null
            ...
            const response5 = weaponIpfs !== null ? await fetch(weaponIpfs.replace("ipfs://", providerIPFS)) : null
            ...
            const response6 = clothIpfs !== null ? await fetch(clothIpfs.replace("ipfs://", providerIPFS)) : null
            ...
            const response7 = hatIpfs !== null ? await fetch(hatIpfs.replace("ipfs://", providerIPFS)) : null
    ...
    <>
        ...
        <div className="fieldBanner" style={{display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-between", textAlign: "left", backgroundImage: "url('" + providerIPFS + "bafybeiehjcwrzylly7xunlan4xqwe2aynokqkgtj65bwxxqq5wfnz4hcnq')", overflow: "scroll"}}>
            ...
            <div style={{margin: "30px 100px"}}>
                <img src={providerIPFS + "bafybeihg7schl77eo7b4amo22htmuscipo4dfioxmajxr4feuqloz2dolm"} width="150" alt="$EE" />
            </div>
        </div>
                    ...
                    <div style={{background: "rgb(194, 155, 231)", color: "#fff", width: "370px", height: "360px", margin: "20px", padding: "20px", display: "flex", flexDirection: "column", justifyContent: "space-around", boxShadow: "3px 3px 0 #0d0a1f"}}>
                        ...
                        <div style={{width: "350px", display: "flex", flexDirection: "row", justifyContent: "space-between", borderBottom: "1px solid #d9d8df"}}>
                            ...
                            <div style={{display: "flex", flexDirection: "row"}}>
                                <img src={providerIPFS + "bafybeihg7schl77eo7b4amo22htmuscipo4dfioxmajxr4feuqloz2dolm"} height="20" alt="$EE"/>
                        ...
                        <div style={{width: "350px", display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-between", borderBottom: "1px solid #d9d8df"}}>
                            ...
                            <div style={{display: "flex", flexDirection: "row"}}>
                                {gasselected === "II" ?
                                    <>
                                        <img src={providerIPFS + "bafybeiffepxbrj2zq2mrlik47tonb2mpp22ymvqmv7o5vpy57fjre4qn6q"} height="20" alt="$II"/>
