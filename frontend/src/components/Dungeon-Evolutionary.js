    ...
    React.useEffect(() => {
        ...
        const thefetch = async () => {
            ...
            for (let i = 0; i <= yournft.length - 1; i++) {
                const response = await fetch(data3[i].result.replace("ipfs://", providerIPFS))
            ...
            for (let i = 0; i <= yoursalonnft.length - 1; i++) {
                const response = await fetch(data5[i].result.replace("ipfs://", providerIPFS))
                const nft = await response.json()

                const bonus = Number(String(yoursalonnft[i].Id).slice(-5))

                salonNfts.push({Id: Number(yoursalonnft[i].Id), Name: nft.name, Image: nft.image.replace("ipfs://", providerIPFS), Description: nft.description, Attribute: nft.attributes, RewardPerSec: bonus, Onsell: false, Count: null})
            }
    ...
    const fusionHandle = async (_nftid, _fusionindex) => {
        ...
        try {
            ...
            if (nftAllow2.toUpperCase() !== fusion.toUpperCase()) {
                ...
                const { hash: hash05 } = await writeContract(config5)
                await waitForTransaction({ hash: hash05 })
            }
            ...
            if (nftAllow3.toUpperCase() !== fusion.toUpperCase()) {
                ...
                const { hash: hash06 } = await writeContract(config6)
                await waitForTransaction({ hash: hash06 })
            }
            ...
            if (nftAllow4.toUpperCase() !== fusion.toUpperCase()) {
                ...
                const { hash: hash07 } = await writeContract(config7)
                await waitForTransaction({ hash: hash07 })
            }
        ...
        <>
            <div className="fieldBanner" style={{display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-between", textAlign: "left", overflow: "scroll"}}>
                ...
                <div style={{margin: "30px 100px"}}>
                    <img src={providerIPFS + "bafybeibb6sv46fa4as36s5pvb5lihvgdhry7jlsifnzca4qbgbvkej3cae"} height="200" alt="Evo_Planet" />
                </div>
            </div>
            ...
            <div style={{width: "90%", display: "flex", flexDirection: "row", justifyContent: "space-between", flexWrap: "wrap", overflow: "scroll"}} className="noscroll">
                <div style={{textAlign: "left", marginTop: "50px", minHeight: "600px", width: "250px", display: "flex", flexDirection: "column", justifyContent: "flex-start"}}>
                    ...
                    <div className="pixel">
                        ...
                        <div style={{width: "200px", minWidth: "200px", height: "55px", margin: "20px 10px 20px 0", fontSize: "15px", border: "1px solid #dddade", boxShadow: "3px 3px 0 #dddade"}} className="items">
                            <img src={providerIPFS + "bafkreibs763pgx6caw3vaqtzv6b2fmkqpwwzvxwe647gywkn3fsydkjlyq"} width="22" alt="$BBQ"/>
                            <div style={{marginLeft: "10px"}}>{Number(bbqBalance).toFixed(3)}</div>
                        </div>
                        <div style={{width: "200px", minWidth: "200px", height: "55px", margin: "20px 10px 20px 0", fontSize: "15px", border: "1px solid #dddade", boxShadow: "3px 3px 0 #dddade"}} className="items">
                            <img src={providerIPFS + "bafkreifq5hc6oprfye7ha3q5lhly545rx6c4idua7v6mrpz5nqxcrefluu"} width="22" alt="$PZA"/>
                                                    ...
                                                    <div style={{justifyContent: "space-around", padding: "30px", marginRight: "50px"}} className="nftCard">
                                                        <div style={{marginTop: "10px", width: "350px", display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-between"}}>
                                                            ...
                                                            <div>
                                                                ...
                                                                {Number(item.Id) % 100000 >= 1000 ? <img src={providerIPFS + "bafkreibjpayqduk7ngifqmwfrnzcohy42xtzxgdrl5dqhsrx5rluvnwdfi"} width="120" alt="Can not load metadata." />  : <></>}
                                                        ...
                                                        <div style={{marginTop: "10px", width: "350px"}}>
                                                            ...
                                                            <div style={{marginTop: "10px", display: "flex", flexDirection: "row"}} className="pixel">
                                                                ...
                                                                {Number(item.Id) % 100000 <= 900 ? <img src={providerIPFS + "bafkreidau3s66zmqwtyp2oimumulxeuw7qm6apcornbvxbqmafvq3nstiq"} height="18" alt="$CU"/> : <></>}
                                                                {Number(item.Id) % 100000 >= 1200 ? <img src={providerIPFS + "bafkreigld4xmmrmu763t2vsju3tqhcodgxxsrmgvrlfhdjktgujgcmpmde"} height="18" alt="$SIL"/> : <></>}
                                                                {Number(item.Id) % 100000 === 1000 ? <img src={providerIPFS + "bafkreia2bjrh7yw2vp23e5lnc6u75weg6nq7dzkyruggsnjxid6qtofeeq"} height="18" alt="$JDAO"/> : <></>}
                                                                <div style={{margin: "0 5px"}}>
                                                    ...
                                                    <div style={{justifyContent: "space-around", padding: "30px", marginRight: "50px"}} className="nftCard">
                                                        <div style={{marginTop: "10px", width: "350px", display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-between"}}>
                                                            ...
                                                            <div>
                                                                ...
                                                                {Number(item.Id) % 100000 === 1500 && <img src={providerIPFS + "bafkreidr4uq5voosuz6v4hqhiempf4a36x5aq6i4uceym2xbje65o5mwia"} width="120" alt="Can not load metadata." />}
                                                                {Number(item.Id) % 100000 === 4500 && <img src={providerIPFS + "bafybeiew47pd67c3l5whmj6vhzullkqvrrsmtlssarwf5s54tnehejaxdu"} width="120" alt="Can not load metadata." />}
                                                                {Number(item.Id) % 100000 === 9500 && <img src={providerIPFS + "bafkreihvuvksuylcjqb37rsgkr5z2l26iliyestxikmjsq7va6xtnnusxe"} width="120" alt="Can not load metadata." />}
                                                                <div style={{width: "150px"}} className="emp pixel">
                                                        ...
                                                        <div style={{marginTop: "10px", width: "350px"}}>
                                                            ...
                                                            <div style={{marginTop: "10px", display: "flex", flexDirection: "row"}} className="pixel">
                                                                ...
                                                                <i style={{fontSize: "12px", margin: "5px 10px 5px 5px"}} className="fa fa-plus"></i>
                                                                {Number(item.Id) % 100000 <= 1300 && <img src={providerIPFS + "bafkreidau3s66zmqwtyp2oimumulxeuw7qm6apcornbvxbqmafvq3nstiq"} height="18" alt="$CU"/>}
                                                                {(Number(item.Id) % 100000 >= 1700 && Number(item.Id) % 100000 <= 4100) && <img src={providerIPFS + "bafkreigld4xmmrmu763t2vsju3tqhcodgxxsrmgvrlfhdjktgujgcmpmde"} height="18" alt="$SIL"/>}
                                                                {Number(item.Id) % 100000 >= 4900 && <img src={providerIPFS + "bafkreia4zjqhbo4sbvbkvlgnit6yhhjmvo7ny4ybobuee74vqlmziskosm"} height="18" alt="$GOLD"/>}
                                                                {(Number(item.Id) % 100000 === 1500 || Number(item.Id) % 100000 === 4500 || Number(item.Id) % 100000 === 9500) && <img src={providerIPFS + "bafkreia2bjrh7yw2vp23e5lnc6u75weg6nq7dzkyruggsnjxid6qtofeeq"} height="18" alt="$JDAO"/>}
                                                                {Number(item.Id) % 100000 >= 10100 && <img src={providerIPFS + "bafkreibf7vowyqjrcaeyslflrxxchel3b4qdpwxcxb34js2otg35vjkcaa"} height="18" alt="$PLAT"/>}
                                                                <div style={{margin: "0 5px"}}>
                                                                    {Number(item.Id) % 100000 === 500 && 0}
                                                ...
                                                {String(item.Id).length === 12 && Number(String(item.Id).slice(0, 4)) === 1004 && Number(String(item.Id).slice(4, 7)) <= 100 ?
                                                    <div style={{justifyContent: "space-around", padding: "30px", marginRight: "50px"}} className="nftCard">
                                                        <div style={{marginTop: "10px", width: "350px", display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-between"}}>
                                                            ...
                                                            <i style={{marginTop: "10px", fontSize: "30px", margin: "2.5px 10px 2.5px 5px"}} className="fa fa-caret-right"></i>
                                                            <div>
                                                                <img src={providerIPFS + "bafkreigeifewiy4kyfle3xi6qsje4kz7mhqvt3xvufv6tes2ocyr6corsq"} width="120" alt="Can not load metadata." />
                                                ...
                                                {Number(String(item.Id).slice(0, 7)) === 1000000  ?
                                                    <div style={{justifyContent: "space-around", padding: "30px", marginRight: "50px"}} className="nftCard">
                                                        <div style={{marginTop: "10px", width: "350px", display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-between"}}>
                                                            ...
                                                            <i style={{marginTop: "10px", fontSize: "30px", margin: "2.5px 10px 2.5px 5px"}} className="fa fa-caret-right"></i>
                                                            <div>
                                                                <img src={providerIPFS + "bafkreif5fecf5rqrlixcxtpzplo7frtftt3yh2cmx6oca4l2jxuryjju2m"} width="120" alt="Can not load metadata." />
