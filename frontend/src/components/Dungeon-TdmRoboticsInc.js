        ...
        <>
            <div className="fieldBanner" style={{display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-between", textAlign: "left", overflow: "scroll"}}>
                ...
                <div style={{margin: "30px 100px"}}>
                    <img src={providerIPFS + "bafybeigac5ws4lgz5pqdt45bdyiqrhsbohguyqng6d7jxsed2c5m3dehe4"} height="230" alt="TDM-ROBOTICS-INC" />
                </div>
            </div>
            ...
            <div style={{width: "90%", display: "flex", flexDirection: "row", justifyContent: "space-between", flexWrap: "wrap", overflow: "scroll"}} className="noscroll">
                <div style={{textAlign: "left", marginTop: "50px", minHeight: "600px", width: "250px", display: "flex", flexDirection: "column", justifyContent: "flex-start"}}>
                    ...
                    <div className="pixel">
                        ...
                        <div style={{width: "200px", minWidth: "200px", height: "55px", margin: "20px 10px 20px 0", fontSize: "15px", border: "1px solid #dddade", boxShadow: "3px 3px 0 #dddade"}} className="items">
                            <img src={providerIPFS + "bafybeiffepxbrj2zq2mrlik47tonb2mpp22ymvqmv7o5vpy57fjre4qn6q"} width="22" alt="$II"/>
                            <div style={{marginLeft: "10px"}}>{Number(iiBalance).toLocaleString('en-US', {maximumFractionDigits:3})}</div>
                        </div>
                        <div style={{width: "200px", minWidth: "200px", height: "55px", margin: "20px 10px 20px 0", fontSize: "15px", border: "1px solid #dddade", boxShadow: "3px 3px 0 #dddade"}} className="items">
                            <img src={providerIPFS + "bafybeihg7schl77eo7b4amo22htmuscipo4dfioxmajxr4feuqloz2dolm"} width="22" alt="$EE"/>
                                                ...
                                                <div style={{justifyContent: "space-around", padding: "30px", marginRight: "40px"}} className="nftCard">
                                                    <div className="emp pixel" style={{marginTop: "10px", width: "350px", display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-between"}}>
                                                        ...
                                                        {Number(item.Id) % 100000 === 26800 &&
                                                            <div>
                                                                {String(item.Id).slice(0, 3) === "100" && <img src={providerIPFS + 'bafybeichx3l6sfsqot3gbk3hzhlbmupsani25zh57dd4ymxwse7mlrfdgy'} width="120" alt="Can not load metadata." />}
                                                                {String(item.Id).slice(0, 3) === "700" && <img src={providerIPFS + 'bafybeiefq2r3t5z7d5yt6gwbckkr2qvrgdgjgd4g764d25nficw2knnrai'} width="120" alt="Can not load metadata." />}
                                                                {String(item.Id).slice(0, 3) === "500" && <img src={providerIPFS + 'bafybeign7h3qhvt3lgconngdstzlwexyo3hgulntvlygvpqzqbgu3haeem'} width="120" alt="Can not load metadata." />}
                                                                {String(item.Id).slice(0, 3) === "300" && <img src={providerIPFS + 'bafybeif4amlgguwmct6dkcu6whcrbrz4lxir6tvyvuxp5dwi6vdoft3zgi'} width="120" alt="Can not load metadata." />}
                                                                {String(item.Id).slice(0, 3) === "200" && <img src={providerIPFS + 'bafybeieljlh4zog6hzjvktizkb6xdswswzxys7rlj4xm7fp47ytizglxpi'} width="120" alt="Can not load metadata." />}
                                                                {String(item.Id).slice(0, 3) === "600" && <img src={providerIPFS + 'bafybeiem3jns3i4lkot6hqe5zxpwj6cnvojukggplenmtsnenqitnk6wki'} width="120" alt="Can not load metadata." />}
                                                                {String(item.Id).slice(0, 3) === "400" && <img src={providerIPFS + 'bafybeieckgtj7nitlnjoiwgy4bzmnnponwlr2h7delw5pfueruz73ztvy4'} width="120" alt="Can not load metadata." />}
                                                        ...
                                                        {Number(item.Id) % 100000 === 42800 &&
                                                            <div>
                                                                {String(item.Id).slice(0, 3) === "100" && <img src={providerIPFS + 'bafybeidlmxivvz4k3ws2kpanq3nob7himsgzagna7sgxxaopcgigvxyove'} width="120" alt="Can not load metadata." />}
                                                                {String(item.Id).slice(0, 3) === "700" && <img src={providerIPFS + 'bafybeihi5ty2pn5b3hridcszupaelj2lm4y5fctfirrp4f5457puemrdsa'} width="120" alt="Can not load metadata." />}
                                                                {String(item.Id).slice(0, 3) === "500" && <img src={providerIPFS + 'bafybeidcqi7ca55k67oeslkcrdqvgs4qul63ezjg6mq542buik4kl6vz7q'} width="120" alt="Can not load metadata." />}
                                                                {String(item.Id).slice(0, 3) === "300" && <img src={providerIPFS + 'bafybeifriz3jssqcl7uzwjexv3chn56awmnmvjklmgdy5uabaovhqlwmwy'} width="120" alt="Can not load metadata." />}
                                                                {String(item.Id).slice(0, 3) === "200" && <img src={providerIPFS + 'bafybeiad4vswhlfjemiylp5r4mlghz4tqag6dn7bimnd5qysnkidlaieai'} width="120" alt="Can not load metadata." />}
                                                                {String(item.Id).slice(0, 3) === "600" && <img src={providerIPFS + 'bafybeifi34uh6hsohnd47wfcynesrwmxot63c65vj4rnwqsc74sjdb7vke'} width="120" alt="Can not load metadata." />}
                                                                {String(item.Id).slice(0, 3) === "400" && <img src={providerIPFS + 'bafybeidkvucspmzjq635okuui5raaozne5bsm7i73cynztbwqlc5uso27u'} width="120" alt="Can not load metadata." />}
                                                        ...
                                                        {Number(item.Id) % 100000 === 64800 &&
                                                            <div>
                                                                {String(item.Id).slice(0, 3) === "100" && <img src={providerIPFS + 'bafybeici6yhhom3u4unmxfiquzgp6f5iod46pz6mwsyujnseeu5szhwdfq'} width="120" alt="Can not load metadata." />}
                                                                {String(item.Id).slice(0, 3) === "700" && <img src={providerIPFS + 'bafybeibrg3peklun2ednncyqftjduu64atrckm5qqdx5dlk5io6rjetxei'} width="120" alt="Can not load metadata." />}
                                                                {String(item.Id).slice(0, 3) === "500" && <img src={providerIPFS + 'bafybeica72phth3kgec4f66t6zla7qu5wgbmezjuvt6ic4sr6zasyy6b6q'} width="120" alt="Can not load metadata." />}
                                                                {String(item.Id).slice(0, 3) === "300" && <img src={providerIPFS + 'bafybeiflj5c5xdevsg5odxepmqrvtpvukntaudqcahrtjwl6fdaeyauiny'} width="120" alt="Can not load metadata." />}
                                                                {String(item.Id).slice(0, 3) === "200" && <img src={providerIPFS + 'bafybeig5hgcjimmkvjanskq6aofpmkhufarvnthqbddekeuygwpofewh2m'} width="120" alt="Can not load metadata." />}
                                                                {String(item.Id).slice(0, 3) === "600" && <img src={providerIPFS + 'bafybeienx6ko3j7mptpootmcdt556z5hud5jyq4vgwibmnxvpmlacsvdvq'} width="120" alt="Can not load metadata." />}
                                                                {String(item.Id).slice(0, 3) === "400" && <img src={providerIPFS + 'bafybeicf6zi22f5nrurejd26qp7vcqq7bjuiil4jya3276qnvpn27mxtwq'} width="120" alt="Can not load metadata." />}
