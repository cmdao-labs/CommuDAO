...
const MechHarvestZone = ({ intrasubModetext, navigate, setisLoading, txupdate, setTxupdate, setisError, setErrMsg, erc20ABI, erc721ABI, gearFieldABI, taoPfpABI }) => {
    ...
    return (
        <>
            ...
            <div className="fieldBanner" style={{display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-between", textAlign: "left",  backgroundImage: "url('https://cloudflare-ipfs.com/ipfs/bafybeidlzwhqtdrt4dnymhtf3v5vbhfwaczn6i3676iqr2aymrwbqbtw4m')", overflow: "scroll"}}>
                ...
                <div style={{margin: "30px 100px"}}>
                    <img src="https://cloudflare-ipfs.com/ipfs/bafybeiegwsyuqu5d47hobxpnuj5zdsy2fgzautcobr6imm3soc4r6uibg4" width="150" alt="$GEAR"/>
                </div>
            </div>
                ...
                <div style={{width: "95%", minHeight: "120px", height: "fit-content", margin: "10px", padding: "20px", fontSize: "14px", flexDirection: "row", justifyContent: "space-around", flexWrap: "wrap"}} className="nftCard">
                    ...
                    <div style={{height: "90%", display: "flex", flexDirection: "column", justifyContent: "space-around"}} className="bold">
                        ...
                        <div style={{fontSize: "24px", display: "flex"}} className="emp">
                            ...
                            <img style={{marginLeft: "10px"}} src="https://cloudflare-ipfs.com/ipfs/bafybeiegwsyuqu5d47hobxpnuj5zdsy2fgzautcobr6imm3soc4r6uibg4" width="26" alt="$GEAR"/>
                        </div>
                    </div>
                    <div style={{height: "90%", display: "flex", flexDirection: "column", justifyContent: "space-around"}} className="bold">
                        ...
                        <div style={{width: 300, padding: 20, border: "1px solid #dddade", borderRadius: 12, display: "flex", flexDirection: "row", alignItem: "center", justifyContent: "space-between"}}>
                            <div style={{lineHeight: 1.5, fontSize: "14px", textAlign: "left"}}>
                                ...
                                <div style={{display: "flex", alignItems: "center"}}>
                                    <img src="https://cloudflare-ipfs.com/ipfs/bafybeiegwsyuqu5d47hobxpnuj5zdsy2fgzautcobr6imm3soc4r6uibg4" width="12" alt="$GEAR"/>
                    ...
                    <div className="nftCard" style={{margin: "10px", padding: "30px 20px", justifyContent: "space-around", fontSize: "18px"}}>
                        ...
                        {pfpLevel === 1 &&
                            <>
                                ...
                                <img src='https://cloudflare-ipfs.com/ipfs/bafybeibvvcappbfq4pw7hvtdwsaageoelga5vwpco3qffcrwzzsk2wxoau' width="250" alt="Can not load metadata." />
                                <div style={{width: "80%", display: "flex", flexDirection: "row", justifyContent: "space-around"}}>
                        ...
                        {pfpLevel === 2 &&
                            <>
                                ...
                                <img src='https://cloudflare-ipfs.com/ipfs/bafybeidqmml2tr67q6rp3sfkbc73lwrraljkex7sf3oandu2m4rpusem4m' width="250" alt="Can not load metadata." />
                                <div style={{width: "80%", display: "flex", flexDirection: "row", justifyContent: "space-around"}}>
                        ...
                        {pfpLevel === 3 &&
                            <>
                                ...
                                <img src='https://cloudflare-ipfs.com/ipfs/bafybeicchn4potn36niuoyhhphltmrljtddira3lwypgpszpzfvju3cpd4' width="250" alt="Can not load metadata." />
                                <div style={{width: "80%", display: "flex", flexDirection: "row", justifyContent: "space-around"}}>
                        ...
                        {pfpLevel === 4 &&
                            <>
                                ...
                                <img src='https://cloudflare-ipfs.com/ipfs/bafybeiaho4pgra7fhociid6zjaavaouctanwf3lxq2ngzujxf4yc2d4yye' width="250" alt="Can not load metadata." />
                                <div style={{width: "80%", display: "flex", flexDirection: "row", justifyContent: "space-around"}}>
                        ...
                        {pfpLevel === 5 &&
                            <>
                                ...
                                <img src='https://cloudflare-ipfs.com/ipfs/bafybeifyq72iygru2iml2hignbjbhn5ud4hsp2zhtfngmyupu754s7ia6y' width="250" alt="Can not load metadata." />
                                <div style={{width: "80%", display: "flex", flexDirection: "row", justifyContent: "space-around"}}>
                        ...
                        {pfpLevel === 6 &&
                            <>
                                ...
                                <img src='https://cloudflare-ipfs.com/ipfs/bafybeicrsr44aadklhu4q4gyzwrtlqbu7vlhf7eyrjdjhyxsfofphh6aiy' width="250" alt="Can not load metadata." />
                                <div style={{width: "80%", display: "flex", flexDirection: "row", justifyContent: "space-around"}}>
                        ...
                        {pfpLevel === 7 &&
                            <>
                                ...
                                <img src='https://cloudflare-ipfs.com/ipfs/bafybeihxvgzhliqnfhppoowu2m4mbb5s52stk52p6hdqawm5ygopxgbmya' width="250" alt="Can not load metadata." />
                                <div style={{width: "80%", display: "flex", flexDirection: "row", justifyContent: "space-around"}}>
                        ...
                        {pfpLevel === 8 &&
                            <>
                                ...
                                <img src='https://cloudflare-ipfs.com/ipfs/bafybeiaghsurj4l7xankdrvrv2whhhy5xasejzusvemstkcloqqbnpovmu' width="250" alt="Can not load metadata." />
                                <div style={{width: "80%", display: "flex", flexDirection: "row", justifyContent: "space-around"}}>
                        ...
                        {pfpLevel === 9 &&
                            <>
                                ...
                                <img src='https://cloudflare-ipfs.com/ipfs/bafybeicuitq5arbmqr5bf33cdrbupv5ojzjwb7jhrl2r4yooeeuoivveku' width="250" alt="Can not load metadata." />
                                <div style={{width: "80%", display: "flex", flexDirection: "row", justifyContent: "space-around"}}>
                        ...
                        {pfpLevel === 10 &&
                            <>
                                ...
                                <img src='https://cloudflare-ipfs.com/ipfs/bafybeihgnsufjnh75b6iw5cj6xaj5ut6z56l3yjrmfua6ogjywit7le2uq' width="250" alt="Can not load metadata." />
                                <div style={{width: "80%", display: "flex", flexDirection: "row", justifyContent: "space-around"}}>
                        ...
                        {pfpLevel === 11 &&
                            <>
                                ...
                                <img src='https://cloudflare-ipfs.com/ipfs/bafybeidzhdrsohkshimumcmwptuvk6fmow6gp3bzuaz44kyuktb5qurcia' width="250" alt="Can not load metadata." />
                                <div style={{width: "80%", display: "flex", flexDirection: "row", justifyContent: "space-around"}}>
                        ...
                        {pfpLevel === 12 &&
                            <>
                                ...
                                <img src='https://cloudflare-ipfs.com/ipfs/bafybeiagcciesftrj2rkbwyci5m4yaurj6nbtmkfyzkviecarq7f77525q' width="250" alt="Can not load metadata." />
                                <div style={{width: "80%", display: "flex", flexDirection: "row", justifyContent: "space-around"}}>
                        ...
                        {pfpLevel === 13 &&
                            <>
                                ...
                                <img src='https://cloudflare-ipfs.com/ipfs/bafybeihhbbdyizbpgnigvzo35asjf56ein5zr4goas2otx3mvmbfec2jzm' width="250" alt="Can not load metadata." />
                                <div style={{width: "80%", display: "flex", flexDirection: "row", justifyContent: "space-around"}}>
                        ...
                        {pfpLevel === 14 &&
                            <>
                                ...
                                <img src='https://cloudflare-ipfs.com/ipfs/bafybeifvulnv2zpqnj4bck3svyjxrgxuo5szubtncg7f6efgm6rby2nqfm' width="250" alt="Can not load metadata." />
                                <div style={{width: "80%", display: "flex", flexDirection: "row", justifyContent: "space-around"}}>
                        ...
                        {pfpLevel === 15 &&
                            <>
                                ...
                                <img src='https://cloudflare-ipfs.com/ipfs/bafybeicyfvc27ylis55sw7txg2lucthwvetrgeeydok722f7anxajobry4' width="250" alt="Can not load metadata." />
                                <div style={{width: "80%", display: "flex", flexDirection: "row", justifyContent: "space-around"}}>
                        ...
                        {pfpLevel === 16 &&
                            <>
                                ...
                                <img src='https://cloudflare-ipfs.com/ipfs/bafybeiafjelnvhz7r3f72xml6jvri3pvhtffrfmyzj5jlq7x5kybxwqohm' width="250" alt="Can not load metadata." />
                                <div style={{width: "80%", display: "flex", flexDirection: "row", justifyContent: "space-around"}}>
                        ...
                        {pfpLevel === 17 &&
                            <>
                                ...
                                <img src='https://cloudflare-ipfs.com/ipfs/bafybeiad3cagzwuu42ugdlhntmnh3kw3fnrpeahwmfn2avt5x2mnkbro4q' width="250" alt="Can not load metadata." />
                                <div style={{width: "80%", display: "flex", flexDirection: "row", justifyContent: "space-around"}}>
                        ...
                        {pfpLevel === 18 &&
                            <>
                                ...
                                <img src='https://cloudflare-ipfs.com/ipfs/bafybeihyiqdlq23yzo4zgqbi3hpvb5iy7yjiezdk2omyonz4p7bkgg27h4' width="250" alt="Can not load metadata." />
                                <div style={{width: "80%", display: "flex", flexDirection: "row", justifyContent: "space-around"}}>
                        ...
                        {pfpLevel === 19 &&
                            <>
                                ...
                                <img src='https://cloudflare-ipfs.com/ipfs/bafybeifttdfppv2cxwdrqve73ls6im7o4rh2utj6uxgvr6pl2w22fsfzti' width="250" alt="Can not load metadata." />
                                <div style={{width: "80%", display: "flex", flexDirection: "row", justifyContent: "space-around"}}>
                        ...
                        {pfpLevel === 20 &&
                            <>
                                ...
                                <img src='https://cloudflare-ipfs.com/ipfs/bafybeicrn3zs6lsv63d7voxzwcqayc6mfva6n56rq2kyh3bf6u4le7baem' width="250" alt="Can not load metadata." />
                                <div style={{width: "80%", display: "flex", flexDirection: "row", justifyContent: "space-around"}}>
