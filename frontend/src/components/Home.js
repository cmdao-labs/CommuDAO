    ...
    <>
        <div style={{overflow: "scroll", padding: 0, margin: 0, textAlign: "left", fontSize: "22px", flexFlow: "row wrap"}} className="collection noscroll welcome pixel">
            <div className="half welcomeText">
                <div style={{display: "flex", flexDirection: "column", alignItems: "flex-start", marginTop: "300px"}}>
                    <div style={{letterSpacing: "1.5px", color: "#fff"}} className="bold motto">Multiverse of crypto community</div>
                    <div style={{padding: "20px 0", marginTop: "30px", flexDirection: "column"}} className="items" id="showoff">
                        ...
                        <div style={{fontSize: "14px", marginTop: "10px", color: "#fff"}} className="light">Transactions on CommuDAO Ecosystem</div>
                    </div>
