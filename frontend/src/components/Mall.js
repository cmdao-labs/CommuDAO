    ...
    React.useEffect(() => {
        ...
        const thefetch = async () => {
            ...
            return [
                ...
                sell19remain, sell20remain, sell21remain, 
        ...
        getAsync().then(result => {
            ...
            setCTunaBalance(ethers.utils.formatEther(String(result[44])))
            setSx31Balance(ethers.utils.formatEther(String(result[45])))
            setJusdtBalance(ethers.utils.formatEther(String(result[46])))
            setCmjBalance(ethers.utils.formatEther(String(result[47])))
            setBbqBalance(ethers.utils.formatEther(String(result[48])))
            setPzaBalance(ethers.utils.formatEther(String(result[49])))
            setCuBalance(ethers.utils.formatEther(String(result[50])))
            setJaspBalance(ethers.utils.formatUnits(String(result[51]), "gwei"))
            setOsBalance(ethers.utils.formatEther(String(result[52])))
            setGoldBalance(ethers.utils.formatEther(String(result[53])))
            setWjbcBalance(ethers.utils.formatEther(String(result[54])))
            setSwarBalance(ethers.utils.formatEther(String(result[55])))
        })
                        ...
                        {address !== null && address !== undefined ?
                            <>
                                {false && sell21Remain > 0 ?
                                    ...
                                    <div style={{borderRadius: "12px", alignSelf: "flex-start", padding: "15px", fontSize: "16px", marginTop: "25px", width: "180px", display: "flex", justifyContent: "center", background: "#e9eaeb", color: "#bdc2c4", cursor: "not-allowed"}} className="pixel button">ON STOCK 8PM, 26.02</div>
                                }
                            </> :
                            <div style={{borderRadius: "12px",alignSelf: "flex-start", padding: "15px", fontSize: "16px", marginTop: "25px", width: "180px", display: "flex", justifyContent: "center", background: "#e9eaeb", color: "#bdc2c4", cursor: "not-allowed"}} className="pixel button">Please connect wallet</div>
                        }
