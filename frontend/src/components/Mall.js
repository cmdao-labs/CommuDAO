    ...
    React.useEffect(() => {
        ...
        const thefetch = async () => {
            ...
            return [
                ...
                sell19remain, sell20remain, sell21remain, sell22remain, sell23remain, _canBuy23, sell24remain, sell25remain, sell26remain, sell27remain, sell28remain,
        ...
        getAsync().then(result => {
            ...
            setCTunaBalance(ethers.utils.formatEther(String(result[52])))
            setSx31Balance(ethers.utils.formatEther(String(result[53])))
            setJusdtBalance(ethers.utils.formatEther(String(result[54])))
            setCmjBalance(ethers.utils.formatEther(String(result[55])))
            setBbqBalance(ethers.utils.formatEther(String(result[56])))
            setPzaBalance(ethers.utils.formatEther(String(result[57])))
            setCuBalance(ethers.utils.formatEther(String(result[58])))
            setJaspBalance(ethers.utils.formatUnits(String(result[59]), "gwei"))
            setOsBalance(ethers.utils.formatEther(String(result[60])))
            setGoldBalance(ethers.utils.formatEther(String(result[61])))
            setWjbcBalance(ethers.utils.formatEther(String(result[62])))
            setSwarBalance(ethers.utils.formatEther(String(result[63])))
            setSilBalance(ethers.utils.formatEther(String(result[64])))
            setJdaoBalance(ethers.utils.formatEther(String(result[65])))
            setAngbBalance(ethers.utils.formatEther(String(result[66])))
        })
                        ...
                        {address !== null && address !== undefined ?
                            <>
                                {false && sell28Remain > 0 ?
                                    ...
                                    <div style={{borderRadius: "12px", alignSelf: "flex-start", padding: "15px", fontSize: "16px", marginTop: "25px", width: "180px", display: "flex", justifyContent: "center", background: "#e9eaeb", color: "#bdc2c4", cursor: "not-allowed"}} className="pixel button">ON STOCK 10PM, 11.03</div>
                                }
                            </> :
                            <div style={{borderRadius: "12px",alignSelf: "flex-start", padding: "15px", fontSize: "16px", marginTop: "25px", width: "180px", display: "flex", justifyContent: "center", background: "#e9eaeb", color: "#bdc2c4", cursor: "not-allowed"}} className="pixel button">Please connect wallet</div>
                        }
