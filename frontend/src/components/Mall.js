...
const Mall = ({ setisLoading, txupdate, setTxupdate, kycABI, ctunaLabABI, cmdaoMerchantABI, cmdaoMerchantKYCABI, cmdaoMerchantV2ABI, cmdaoGasha02ABI, ammyABI, ammyStdABI, angeloStdABI, cmdaoAmmNpcABI, erc20ABI }) => {
    ...
    React.useEffect(() => {
        ...
        const thefetch = async () => {
            ...
            const sell23remain = (510040000000 - (Number(sell23Id.sellId) - 10100)) / 100000
            const _canBuy23 = Number(ethers.utils.formatEther(String(silBal))) >= 500000 ? true : false
            ...
            return [
                ...
                sell19remain, sell20remain, sell21remain, sell22remain, sell23remain, _canBuy23, sell24remain, sell25remain, sell26remain, 
        ...
        getAsync().then(result => {
            ...
            setCTunaBalance(ethers.utils.formatEther(String(result[50])))
            setSx31Balance(ethers.utils.formatEther(String(result[51])))
            setJusdtBalance(ethers.utils.formatEther(String(result[52])))
            setCmjBalance(ethers.utils.formatEther(String(result[53])))
            setBbqBalance(ethers.utils.formatEther(String(result[54])))
            setPzaBalance(ethers.utils.formatEther(String(result[55])))
            setCuBalance(ethers.utils.formatEther(String(result[56])))
            setJaspBalance(ethers.utils.formatUnits(String(result[57]), "gwei"))
            setOsBalance(ethers.utils.formatEther(String(result[58])))
            setGoldBalance(ethers.utils.formatEther(String(result[59])))
            setWjbcBalance(ethers.utils.formatEther(String(result[60])))
            setSwarBalance(ethers.utils.formatEther(String(result[61])))
            setSilBalance(ethers.utils.formatEther(String(result[62])))
            setJdaoBalance(ethers.utils.formatEther(String(result[63])))
            setAngbBalance(ethers.utils.formatEther(String(result[64])))
        })
        ...
        <div className="collection">
            <div style={{textAlign: "left", height: "fit-content", width: "90%", display: "flex", flexDirection: "column", justifyContent: "flex-start"}} className="pixel">
                ...
                <div style={{width: "100%", display: "flex", flexDirection: "row", justifyContent: "flex-start", overflow: "scroll"}} className="noscroll">
                    ...
                    <Ammmerchant2 setisLoading={setisLoading} setTxupdate={setTxupdate} ammyStdABI={ammyStdABI} cmdaoAmmNpcABI={cmdaoAmmNpcABI} erc20ABI={erc20ABI} jdaoBalance={jdaoBalance} cuBalance={cuBalance} silBalance={silBalance} goldBalance={goldBalance} jaspBalance={jaspBalance} osBalance={osBalance} cmjBalance={cmjBalance} />
                ...
                <div style={{width: "100%", display: "flex", flexDirection: "row", justifyContent: "flex-start", overflow: "scroll"}} className="noscroll">
                    ...
                    <div className="nftCard" style={{position: "relative", justifyContent: "flex-start", height: "460px", margin: "20px", boxShadow: "6px 6px 0 #00000040", border: "1px solid rgb(227, 227, 227)"}}>
                        ...
                        <img style={{alignSelf: "flex-start", marginTop: "20px"}} src="https://nftstorage.link/ipfs/bafybeiglw3a5wuszv7zkmfw55e2bcaoxinsjwjinckccg4lxg2juoeegmu" height="150" alt="X8-HAPTIC-BODYSUIT"/>
                        <div style={{alignSelf: "flex-start", marginTop: "10px", minHeight: "200px", fontSize: "15px"}} className="pixel">
                            <div style={{marginTop: "20px", width: "350px", display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-between", borderBottom: "1px solid #d9d8df"}}>
                                <div>Limited</div>
                                <div style={{display: "flex", flexDirection: "row"}}>
                        ...
                        {address !== null && address !== undefined ?
                            <>
                                {false && sell26Remain > 0 ?
                                    ...
                                    <div style={{borderRadius: "12px", alignSelf: "flex-start", padding: "15px", fontSize: "16px", marginTop: "25px", width: "180px", display: "flex", justifyContent: "center", background: "#e9eaeb", color: "#bdc2c4", cursor: "not-allowed"}} className="pixel button">ON STOCK 10PM, 09.03</div>
                                }
                            </> :
                            <div style={{borderRadius: "12px",alignSelf: "flex-start", padding: "15px", fontSize: "16px", marginTop: "25px", width: "180px", display: "flex", justifyContent: "center", background: "#e9eaeb", color: "#bdc2c4", cursor: "not-allowed"}} className="pixel button">Please connect wallet</div>
                        }
                ...
                <div style={{width: "100%", display: "flex", flexDirection: "row", justifyContent: "flex-start", overflow: "scroll", marginBottom: "40px"}} className="noscroll">
                    ...
                    <div className="nftCard" style={{justifyContent: "flex-start", height: "460px", margin: "20px", boxShadow: "6px 6px 0 #00000040", border: "1px solid rgb(227, 227, 227)"}}>
                        <div style={{alignSelf: "flex-start", fontSize: "16px", width: "380px"}}className="pixel">To Infinity and Beyond</div>
                        <img style={{alignSelf: "flex-start", marginTop: "20px"}} src="https://nftstorage.link/ipfs/bafkreicuzof3ucge5we4wwdsl6et44idilvst2bl4uuvwnl5vbdrxof6oy" height="150" alt="TO-INFINITY-N-BEYOND"/>
                        <div style={{alignSelf: "flex-start", marginTop: "10px", minHeight: "200px", fontSize: "15px"}} className="pixel">
                            <div style={{marginTop: "20px", width: "350px", display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-between", borderBottom: "1px solid #d9d8df"}}>
                                <div>Limited</div>
                                <div style={{display: "flex", flexDirection: "row"}}>
