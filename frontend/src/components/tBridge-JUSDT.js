    ...
    return (
        <div style={{position: "relative", background: "rgb(0, 19, 33)", width: "100%", height: "100%", minHeight: "100vh"}}>
            ...
            <div style={{width: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", flexWrap: "wrap", color: "#fff", overflow: "scroll"}} className="noscroll pixel">
                {defaultAccount !== "" ?
                    <div style={{width: "fit-content", height: "27px", background: "#001a2c", boxShadow: "0 0 10px rgb(0 0 0 / 4%), 0 0 0 1px #2e2c35", border: "1px solid transparent", color: "#fff", fontSize: "16px", padding: "10px 25px", position: "absolute", top: "30px", right: "40px", letterSpacing: "0.5px"}}>
                    ...
                    <div style={{width: "fit-content", height: "27px", background: "linear-gradient(73.28deg, #495BFC 6.51%, #114188 88.45%)", boxShadow: "0 0 10px rgb(0 0 0 / 4%), 0 0 0 1px #2e2c35", border: "1px solid transparent", color: "#fff", fontSize: "16px", padding: "10px 25px", position: "absolute", top: "30px", right: "40px", letterSpacing: "0.5px", cursor: "pointer"}} onClick={connectwalletHandler}>
                ...
                <div style={{width: "70%", padding: "50px 45px 50px 0", margin: "10px 0", background: "transparent", display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", fontSize: "16px"}}>
                ...
                <div style={{height: "140px", marginBottom: "200px", width: "1200px", maxWidth: "90%", display: "flex", flexDirection: "column", alignItems: "flex-start", justifyContent: "space-between", flexWrap: "wrap", fontSize: "16px"}}>
                    <div style={{width: "40%", padding: "40px 10px", boxShadow: "0 0 10px rgb(0 0 0 / 4%), 0 0 0 1px #2e2c35", display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-around", flexWrap: "wrap"}}>
                        ...
                        {chainId === 96 && ethereum !== undefined ? 
                            <div style={{maxHeight: "47px", maxWidth: "fit-content", display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "flex-start", background: "linear-gradient(73.28deg, #495BFC 6.51%, #114188 88.45%)"}} className="button" onClick={depositHandle}>BRIDGE TO JBC</div> : 
                    ...
                    <div style={{width: "40%", padding: "40px 10px", boxShadow: "0 0 10px rgb(0 0 0 / 4%), 0 0 0 1px #2e2c35", display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-around", flexWrap: "wrap"}}>
                        ...
                        {chainId === 8899 && ethereum !== undefined ?
                            <div style={{maxHeight: "47px", maxWidth: "fit-content", display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "flex-start", background: "linear-gradient(73.28deg, #495BFC 6.51%, #114188 88.45%)"}} className="button" onClick={withdrawHandle}>BRIDGE TO BKC</div> :
