...
contract Plat_Factory01 is ReentrancyGuard, Ownable {
    ...
    function craft(uint256 _index) external nonReentrant {
        ...
        ERC20(token1).transferFrom(msg.sender, address(1), machine[_index].token1Cost);
    ...
    function obtain() external nonReentrant {
        ...
        plat(platToken).mint(1, msg.sender, reward);
    }
}