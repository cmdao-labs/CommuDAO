...
contract CMDAO_Meow_Exchange is ERC20, ReentrancyGuard {
    address public token;
    address public cmj;
    address public merchant;

    constructor(address _token, address _cmj, address _merchant) ERC20("meow-cmj LP Token", "MEOW-LP") {
        token = _token;
        cmj = _cmj;
        merchant = _merchant;
    }
    ...
    function cmjTOtoken(uint256 _tokensSold, uint256 _minTokens) external nonReentrant {
        ...
        ERC20(cmj).transfer(merchant, (_tokensSold/100) * 4);
